      ...
      .then((willDelete) => {
        if (willDelete) 
        {
          ...
          $.ajax({
            ...
            data:{ids:ids},
            success:function(response){ 
              iziToast.success({title: '',message: Your_Moz_Rank_data_has_been_deleted_successfully ,position: 'bottomRight'});
              table.draw();
            }
          });
        } 
      ...
      .then((willDelete) => {
        if (willDelete) 
        {
          ...
          $.ajax({
            ...
            data:{ids:ids},
            success:function(response){ 
              iziToast.success({title: '',message: Your_All_Moz_rank_data_has_been_deleted_successfully ,position: 'bottomRight'});
              table.draw();
            }
          });
        } 
