      ...
      .then((willDelete) => {
        if (willDelete) 
        {
          ...
          $.ajax({
            context: this,
            type:'POST' ,
            url:keyword_position_delete,
            beforeSend: function (xhr) {
              xhr.setRequestHeader('X-CSRF-TOKEN', csrf_token);
            },
            data:{ids:ids},
            success:function(response){ 
              iziToast.success({title: '',message: Your_keyword_position_analysis_data_has_been_deleted_successfully,position: 'bottomRight'});
              table.draw();
            }
          });
        } 
      ...
      .then((willDelete) => {
        if (willDelete) 
        {
          ...
          $.ajax({
            ...
            data:{ids:ids},
            success:function(response){ 
              iziToast.success({title: '',message: Your_all_keyword_position_data_has_been_deleted_successfully,position: 'bottomRight'});
              table.draw();
            }
          });
        } 
