...
<section class="section">
  <div class="section-header">
    ...
    <div class="section-header-breadcrumb">
      ...
      <div class="breadcrumb-item active"><a href="{{route('add_on_manager')}}"><?php echo __("Add-on Manager"); ?></a></div>
        ...
        <div class="col-12 col-md-6">
          <div class="card">
            <div class="card-header">
              <h4><i class="fas fa-cloud-upload-alt"></i> <?php echo __("Upload New Add-on"); ?></h4>
            </div>
            <div class="card-body">
  ...
  $("document").ready(function(){
    ...
    $("#addon_url_upload").uploadFile({
        ...
        deleteCallback: function (data, pd) {
            var delete_url=base_url+'/addons/delete_uploaded_zip';
