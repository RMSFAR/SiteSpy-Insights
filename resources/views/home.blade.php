...
<head>
	...
	<!-- Favicon -->
    <link rel="shortcut icon" href="{{ asset('assets/favicon/urlfavicon.png') }}" type="image/x-icon">

    <!--====== STYLESHEETS ======-->
    <link rel="stylesheet" href="{{asset('mainlanding/site_new/css/normalize.css')}}">
    <link rel="stylesheet" href="{{asset('mainlanding/site_new/css/animate.css')}}">
    <link rel="stylesheet" href="{{asset('mainlanding/site_new/css/modal-video.min.css')}}">
    <link rel="stylesheet" href="{{asset('mainlanding/site_new/css/stellarnav.min.css')}}">
    <link rel="stylesheet" href="{{asset('mainlanding/site_new/css/owl.carousel.css')}}">
    <link rel="stylesheet" href="{{asset('mainlanding/site_new/css/slick.css')}}">
    <link href="{{asset('mainlanding/site_new/css/bootstrap.min.css')}}" rel="stylesheet">
     {{-- <link href="{{asset('mainlanding/site_new/css/font-awesome.min.css')}}" rel="stylesheet"> --}}
    <link rel="stylesheet" href="{{asset('assets/modules/fontawesome/css/all.min.css')}}">
    <link rel="stylesheet" href="{{asset('assets/modules/fontawesome/css/v4-shims.min.css')}}">
    <link href="{{asset('mainlanding/site_new/css/material-icons.css')}}" rel="stylesheet">


    <!--====== MAIN STYLESHEETS ======-->
    {{-- <!-- <link rel="stylesheet" href="{{asset('assets/css/site/style.css')}}"> --> --}}
    @include("shared.style")
    <link rel="stylesheet" href="{{asset('mainlanding/site_new/css/custom.css')}}">
    <link href="{{asset('mainlanding/site_new/css/responsive.css')}}" rel="stylesheet">

    <script src="{{asset('mainlanding/site_new/js/vendor/modernizr-2.8.3.min.js')}}"></script>
    <!-- sweetalert -->
...
<body class="home-two" data-spy="scroll" data-target=".mainmenu-area" data-offset="90">
                    ...
                    <div class="row flex-v-center">
                        <div class="col-md-7 col-lg-7 col-sm-12 col-xs-12">
                            <div class="welcome-mockup center">
                                <img src="{{asset('mainlanding/site_new/img/home/watch-mockup.png')}}" alt="">
                            </div>
                        </div>
                        <div class="col-md-7 col-lg-7 col-sm-12 col-xs-12">
                            <div class="welcome-text">
                                <h1><span><?php echo config('my_config.product_name'); ?></span></h1>
                                <span class="em"><?php echo __("catch line"); ?></span>
                                ...
                                <div class="home-button" <?php if(config('frontend.front_end_search_display')=='0' || config('frontend.front_end_search_display')=='') echo "style='margin-top: 30px;'" ?>>
                                    ...
                                    <a <?php if(config('frontend.enable_signup_form') =='0') echo "class='hidden'"; ?> href="{{route('register')}}"><?php echo __("Sign up now"); ?></a>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row">
                <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
                    <div class="intro-image wow fadeIn text-center">
                        ...
                        <img src="{{asset('mainlanding/site_new/img/mockups/home-two-promo-mockup.png')}}" alt="" style="max-width: 82%;margin:0 auto;">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row flex-v-center">
                <div class="col-md-4 col-lg-4 col-sm-6 col-xs-12">
                    <div class="qs-box pos-icon-right mb100 wow fadeIn">
                        <div class="qs-box-icon">
                            <img src="{{asset('mainlanding/site_new/img/icon/icon-1.png')}}" alt="">
                        </div>
                    ...
                    <div class="qs-box  pos-icon-right wow fadeIn xs-mb50">
                        <div class="qs-box-icon">
                            <img src="{{asset('mainlanding/site_new/img/icon/icon-2.png')}}" alt="">
                        </div>
                ...
                <div class="col-md-4 col-lg-4 col-sm-4 col-xs-12 hidden-xs hidden-sm">
                    <div class="service-image text-center wow fadeIn xs-mb50">
                        <img src="{{asset('mainlanding/site_new/img/mockups/home-two-work-mockup.png')}}" alt="">
                    </div>
                </div>
                <div class="col-md-4 col-lg-4 col-sm-6 col-xs-12 pull-left">
                    <div class="qs-box  pos-icon-left mb100 wow fadeIn">
                        <div class="qs-box-icon">
                            <img src="{{asset('mainlanding/site_new/img/icon/icon-3.png')}}" alt="">
                        </div>
                    ...
                    <div class="qs-box pos-icon-left wow fadeIn">
                        <div class="qs-box-icon">
                            <img src="{{asset('mainlanding/site_new/img/icon/icon-4.png')}}" alt="">
                        </div>
            ...
            <div class="row flex-v-center">
                <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12">
                    <div class="about-content sm-mb50 sm-center">
                        ...
                        <p class="description"><?php echo __('description 1');?></p>
                        <p class="description"><?php echo __('description 2');?></p>
                        <p class="description"><?php echo __('description 3');?></p>
                        <p class="description"><?php echo __('description 4');?></p>
                ...
                <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12">
                    <div class="about-mockup center wow fadeIn xs-mt50">
                        <img src="{{asset('mainlanding/site_new/img/mockups/home-two-about-mockup.png')}}" alt="">
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="promo-area-content center white wow fadeIn">
                        <div class="video-promo-slider">
                            <div class="single-video-promo-slide">
                                <img src="{{asset('mainlanding/site_new/img/promo/video-promo-slide-1.png')}}" alt="">
                    ...
                    <div class="screenshot-slider-area wow fadeIn xs-mb50">
                        <div class="screenshot-slider-2">
                            <div class="single-screenshot">
                                <img src="{{asset('mainlanding/site_new/img/screenshot/screenshot-1.jpg')}}" alt="">
                            </div>
                            <div class="single-screenshot">
                                <img src="{{asset('mainlanding/site_new/img/screenshot/screenshot-2.jpg')}}" alt="">
                            </div>
                            <div class="single-screenshot">
                                <img src="{{asset('mainlanding/site_new/img/screenshot/screenshot-3.jpg')}}" alt="">
                            </div>
                            <div class="single-screenshot">
                                <img src="{{asset('mainlanding/site_new/img/screenshot/screenshot-4.jpg')}}" alt="">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row flex-v-center">
                ...
                <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12 <?php if(config('my_config.customer_review_video') == '') echo 'hidden';?>">
                    <div class="video-area-content wow fadeIn sm-mb50 xs-mb50">
                        <img src="{{asset('mainlanding/site_new/img/video/review-bg.jpg')}}" alt="">
                    ...
                    <div class="col-md-6 col-lg-6 col-md-offset-3 col-lg-offset-3 col-sm-12 col-xs-12">
                        <div class="footer-social-bookmark text-center section-padding wow fadeIn">
                            <div class="footer-logo mb50 hidden-xs">
                                <a href="#"><img src="{{asset('assets/img/logo.png')}}" alt="logo" style="max-height: 70px;"></a>
                            </div>
                    ...
                    <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
                        <div class="footer-copyright text-center wow fadeIn" style="padding-bottom: 55px;">
                            ...
                            <p class="text-center" style="font-size: 10px;">
                                <a href="<?php echo url('/home/privacy_policy'); ?>" target="_blank"><?php echo __("Privacy Policy"); ?></a> | <a href="<?php echo url('home/terms_use'); ?>" target="_blank"><?php echo __("Terms of Service"); ?></a> | <a href="<?php echo url('home/gdpr'); ?>" target="_blank"><?php echo __("GDPR Compliant"); ?></a>
                            </p>
                        </div>
                    </div>
                </div>
    ...
    <!--====== SCRIPTS JS ======-->
    <script src="{{asset('mainlanding/site_new/js/vendor/jquery-1.12.4.min.js')}}"></script>
    <script src="{{asset('mainlanding/site_new/js/vendor/bootstrap.min.js')}}"></script>

    <!--====== PLUGINS JS ======-->
    <script src="{{asset('mainlanding/site_new/js/vendor/jquery.easing.1.3.js')}}"></script>
    <script src="{{asset('mainlanding/site_new/js/vendor/jquery-migrate-1.2.1.min.js')}}"></script>
    <script src="{{asset('mainlanding/site_new/js/vendor/jquery.appear.js')}}"></script>
    <script src="{{asset('mainlanding/site_new/js/owl.carousel.min.js')}}"></script>
    <script src="{{asset('mainlanding/site_new/js/slick.min.js')}}"></script>
    <script src="{{asset('mainlanding/site_new/js/stellar.js')}}"></script>
    <script src="{{asset('mainlanding/site_new/js/wow.min.js')}}"></script>
    <script src="{{asset('mainlanding/site_new/js/jquery-modal-video.min.js')}}"></script>
    <script src="{{asset('mainlanding/site_new/js/stellarnav.min.js')}}"></script>
    <script src="{{asset('mainlanding/site_new/js/contact-form.js')}}"></script>
    <script src="{{asset('mainlanding/site_new/js/jquery.ajaxchimp.js')}}"></script>
    <script src="{{asset('mainlanding/site_new/js/jquery.sticky.js')}}"></script>
    <script src="{{asset('assets/modules/nicescroll/jquery.nicescroll.min.js')}}"></script>

    <!--===== ACTIVE JS=====-->
    <script src="{{asset('mainlanding/site_new/js/main.js')}}"></script>

    <!-- cookiealert section -->
{{-- @php
    include config('settings.pixel_code');
    include config('settings.google_code');
@endphp --}}
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        $('#submit').click(function(e){
            ...
            if(output === false)
            {
              swal('<?php echo __("Warning"); ?>', '<?php echo __('Please provide a domain name in valid format.')?>', 'warning');
              return;
            }

            if(domain_name == '') {
                swal('<?php echo __("Warning")?>', '<?php echo __("you have not entered any domain name") ?>', 'warning');
                return false;
            } else {
                ...
                $.ajax({
                    type:'POST' ,
                    url: "<?php echo url('/'); ?>/home/front_end_website_analysis",
