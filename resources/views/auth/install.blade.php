...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" dir="{{config('app.localeDirection')}}">
  ...
  <head>
    ...
    <title>{{config('my_config.product_name')}} - Install</title>
  ...
  <body class="{{config('app.localeDirection')}}">
    <div class="container-fluid">
      <div class="row">
          <div class="col-12">
              <a class="text-center" href="{{ url('/') }}"><img  src="{{config('my_config.logo')}}" class="mt-4" width="200" alt="<?php echo config('product_name');?>"></a><a style="color:red;" href="https://cutt.ly/PLFZenO" target="_blank">NULLED Web Community</a><br><br>
           </div>
                       ...
                       <div class="row">
                          <div class="form-group col-12 my-2">
                            <div class="input-row">
                              ...
                              <label><?php echo config('my_config.product_name') ?> <b>Admin Login Email *</b></label>
                         ...
                         <div class="form-group col-12">
                            <div class="input-row">
                              <label><?php echo config('my_config.product_name') ?> <b>Admin Login Password *</b></label>
