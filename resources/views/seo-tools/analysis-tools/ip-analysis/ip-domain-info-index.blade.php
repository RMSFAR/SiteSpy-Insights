...
<section class="section section_custom">
  <div class="section-header">
    ...
    <div class="section-header-button">
     <a class="btn btn-primary" href="{{route("domain_info_new")}}">
...
<script>
  ...
  var Your_domain_analysis_data_has_been_deleted_successfully = '{{ __('Your domain analysis data has been deleted successfully.') }}';
  var Your_all_domain_analysis_data_has_been_deleted_successfully = '{{ __('Your all domain analysis data has been deleted successfully.') }}';
  
  var domain_info_data = '{{ route('domain_info_data') }}';
  var domain_info_download = '{{ route('domain_info_download') }}';
  var domain_info_delete = '{{ route('domain_info_delete') }}';
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content" style="background: #fefefe;">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel"><i class="fas fa-map-marker-alt"></i> {{ __('Domain Ip Information')}}</h5>
