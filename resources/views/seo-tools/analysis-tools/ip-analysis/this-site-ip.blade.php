...
<section class="section section_custom">
  <div class="section-header">
    ...
    <div class="section-header-button">
     <a class="btn btn-primary" href="{{route("site_this_ip_new")}}">
...
<script>
  ...
  "use strict";
  var Your_sites_compability_check_data_has_been_deleted_successfully = '{{ __('Your sites in same ip data has been deleted successfully.') }}';
  var Your_all_sites_compability_check_data_has_been_deleted_successfully = '{{ __('Your all sites in same ip data has been deleted successfully.') }}';
  var site_this_ip_data = '{{ route('site_this_ip_data') }}';
  var site_this_ip_download = '{{ route('site_this_ip_download') }}';
  var site_this_ip_delete = '{{ route('site_this_ip_delete') }}';


</script>
  
<script src="{{asset('assets/custom-js/analysis-tools/this-site.js')}}"></script>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content" style="background: #fefefe;">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel"><i class="fas fa-map-marker-alt"></i> {{ __('Sites In Same IP')}}</h5>
