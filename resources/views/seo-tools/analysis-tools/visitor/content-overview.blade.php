<div role="tabpanel" class="tab-pane" id="content_overview">	
	...
	<div class="row" style="margin-top: 20px;">
		...
		<div class="col-xs-12 col-lg-1" style="margin-top:25px;"><button class="btn btn-info search_button"><i class="fa fa-search"></i> {{ __("search")}}</button></div>
		
		<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
			<div class="box box-primary">
				<div class="box-header with-border">
					<h3 style="color: blue; word-spacing: 5px;" class="box-title"><i class="fa fa-star"></i> {{ __('Top Web Pages From')}}<span id="content_overview_from_date"></span> To <span id="content_overview_to_date"></span></h3>
