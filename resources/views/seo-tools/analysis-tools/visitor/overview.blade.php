		...
		<div class="form-group">
		  <div class="input-group mb-3">
		    ...
		    <div class="input-group-append">
		      <button class="btn btn-info search_button" type="button" id="add_domain"><i class="fa fa-search"></i> {{ __('Search')}}</button>
		    </div>
		  </div>
		</div>
	</div>
	...
	<div class="col-12">
	  <div class="card">
	    <div class="card-header">
	      <h4><i class="far fa-chart-bar"></i> {{ __('Day Wise New Visitor Report From')}} <span id="overview_from_date"></span> {{ __('to')}} <span id="overview_to_date"></span></h4>
	    </div>
	    <div class="card-body">
