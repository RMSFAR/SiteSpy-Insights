<div class="row">
	...
	<div class="col-12">
	  <div class="card">
	    <div class="card-header">
	      <h4><i class="far fa-chart-bar"></i> {{ __('Day Wise New vs Returning User Report From')}} <span id="visitor_type_from_date"></span> {{ __('to')}} <span id="visitor_type_to_date"></span></h4>
	    </div>
	    <div class="card-body">
	...
	<div class="col-12 col-md-6">
	  <div class="card">
	    <div class="card-header">
	      <h4><i class="fas fa-users"></i> {{ __('Total New vs Returning User')}}</h4>
	    </div>
	    <div class="card-body">
	...
	<div class="col-12 col-md-6">
	  <div class="card">
	    <div class="card-header">
	      <h4><i class="fas fa-star"></i> {{ __('Top Web Pages From')}} <span id="content_overview_from_date"></span> {{ __('to')}} <span id="content_overview_to_date"></span></h4>
	    </div>
	    <div class="card-body">
