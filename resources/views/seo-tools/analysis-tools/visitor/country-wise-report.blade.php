	...
	<div class="col-12">
	  ...
	  <div class="card">
	    ...
	    <div class="card-header">
	      ...
	      <h4><i class="fas fa-flag"></i> {{ __('Country Wise New Visitor Report')}}</h4>
	...
	<div class="col-12">
	  ...
	  <div class="card">
	    ...
	    <div class="card-header">
	      ...
	      <h4><i class="fa fa-map-marker"></i> {{ __('Country Wise Report From')}} <span id="country_wise_visitor_from_date"></span> {{ __('To')}} <span id="country_wise_visitor_to_date"></span></h4>
