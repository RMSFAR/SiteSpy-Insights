...
<section class="section section_custom">
  <div class="section-header">
    ...
    <div class="section-header-button">
     <a class="btn btn-primary" href="{{route("position_keyword_new")}}">
...
<script>  
  ...
  var Your_all_keyword_position_data_has_been_deleted_successfully = '{{ __('Your all keyword position data has been deleted successfully.') }}';
  var Your_keyword_position_analysis_data_has_been_deleted_successfully = '{{ __('Your keyword position analysis data has been deleted successfully.') }}';

  var keyword_position_data = '{{ route('keyword_position_data') }}';
  var keyword_position_download = '{{ route('keyword_position_download') }}';
  var keyword_position_delete = '{{ route('keyword_position_delete') }}';
</script>

<script src="{{asset('assets/custom-js/analysis-tools/keyword-position.js')}}"></script>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content" style="background: #fefefe;">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel"><i class="fas fa-tag"></i> {{ __('Keyword Position Analysis')}}</h5>
