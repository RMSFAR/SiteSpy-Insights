...
<section class="section section_custom">
    <div class="section-header">
      ...
      <div class="section-header-button">
       <a class="btn btn-primary" href="{{route('moz_rank_analysis')}}">
              ...
              <div class="table-responsive2">
                  ...
                  <thead>
                      <tr>
                                  ...
                                  <th>{{ __("ID")}}</th>            
                      <th>{{ __("Subdomain Normalized")}}</th>         
                      <th>{{ __("Subdomain Raw")}}</th>
                      <th>{{ __("URL Normalized")}}</th>
                      <th>{{ __("URL Raw")}}</th>
                      <th>{{ __("HTTP Status Code")}}</th>
                      <th>{{ __("Domain Authority")}}</th>
                      <th>{{ __("Page Authority")}}</th>
                      <th>{{ __("External Equity Links")}}</th>
                      <th>{{ __("Links")}}</th>
                      <th>{{ __("URL")}}</th>
...
<script>       
  var Your_Moz_Rank_data_has_been_deleted_successfully = '{{ __("Your Moz Rank data has been deleted successfully.") }}';
  var Your_All_Moz_rank_data_has_been_deleted_successfully = '{{ __("Your All Moz rank data has been deleted successfully.") }}';
  var moz_rank_data = '{{ route("moz_rank_data") }}';
  var moz_rank_download = '{{ route("moz_rank_download") }}';
  var moz_rank_delete = '{{ route("moz_rank_delete") }}';

</script>

<script src="{{asset('assets/custom-js/analysis-tools/moz-rank.js')}}"></script>
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content" style="background: #fefefe;">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLabel"><i class="fas fa-trophy"></i> {{ __('Moz Rank')}}</h5>
