...
<div class="row">
	<div class="col-12 col-md-6">
		<div class="card card-hero">
			<div class="card-header">
				...
				<div class="card-description"><?php echo __('TITLE & METATAGS'); ?></div>
			</div>
	...
	<div class="col-12 col-md-6">
		<div class="card card-hero">
			<div class="card-header">
				...
				<div class="card-description"><?php echo __('HTML HEADINGS'); ?></div>
			</div>
	...
	<div class="col-12">
		<div class="card card-primary">
			<div class="card-header">
				<h4><i class="fas fa-info-circle"></i> <?php echo __('Other Informations'); ?></h4>
			</div>
					...
					<div class="row">
						<div class="col-12 col-md-6">
							<li class="list-group-item d-flex justify-content-between align-items-center mb-2">
								<span><?php echo __('BLOCKED BY ROBOTS.TXT'); ?></span>
						...
						<div class="col-12 col-md-6">
							<li class="list-group-item d-flex justify-content-between align-items-center mb-2">
								<span><?php echo __('BLOCKED BY META-ROBOTS'); ?></span>
								<span class="badge badge-primary badge-pill">
									<?php 
						...
						<div class="col-12 col-md-6">
							<li class="list-group-item d-flex justify-content-between align-items-center mb-2">
								<span><?php echo __('LINKS NOFOLLOWED BY META-ROBOTS'); ?></span>
								<span class="badge badge-primary badge-pill">
									<?php 
						...
						<div class="col-12 col-md-6">
							<li class="list-group-item d-flex justify-content-between align-items-center mb-2">
								<span><?php echo __('TOTAL KEYWORDS'); ?></span>
	...
	<div class="col-12">
		<div class="card">
			<div class="card-header">
				<h4><i class="fas fa-key"></i> <?php echo __('Keyword Analysis'); ?></h4>
				...
				<div class="card-body keyword_analysis_body">
					<div class="row">
						...
						<div class="col-12">
							<div class="card card-primary">
								<div class="card-header">
									<h4><?php echo __('Single Word Phrases'); ?></h4>
									<div class="card-header-action">
										...
										<div class="table-responsive" <?php if(is_array($one_phrase) && count($one_phrase) > 0) echo 'style="height: 300px;"'?>>
											<table class="table table-hover table-striped table-bordered text-center">
												<thead class="thead-light thead-primary">
													<tr>
														<th scope="col"><?php echo __('Single Keyword'); ?></th>
														<th scope="col"><?php echo __('Occurrences'); ?></th>
														<th scope="col"><?php echo __('Density'); ?></th>
														<th scope="col"><?php echo __('Possible Spam'); ?></th>
													</tr>
												</thead>
												<tbody>
						...
						<div class="col-12">
							<div class="card card-primary">
								<div class="card-header">
									<h4><?php echo __('2 Word Phrases'); ?></h4>
									<div class="card-header-action">
									...
									<div class="card-body">
										<div class="table-responsive" <?php if(is_array($two_phrase) && count($two_phrase) > 0) echo 'style="height: 300px;"'?>>
											<table class="table table-hover table-striped table-bordered text-center">
												<thead class="thead-light thead-primary">
													<tr>
														<th scope="col"><?php echo __('2 WORD PHRASES'); ?></th>
														<th scope="col"><?php echo __('Occurrences'); ?></th>
														<th scope="col"><?php echo __('Density'); ?></th>
														<th scope="col"><?php echo __('Possible Spam'); ?></th>
													</tr>
						...
						<div class="col-12">
							<div class="card card-primary">
								<div class="card-header">
									<h4><?php echo __('3 WORD PHRASES'); ?></h4>
									<div class="card-header-action">
									...
									<div class="card-body">
										<div class="table-responsive" <?php if(is_array($three_phrase) && count($three_phrase) > 0) echo 'style="height: 300px;"'?>>
											<table class="table table-hover table-striped table-bordered text-center">
												<thead class="thead-light thead-primary">
													<tr>
														<th scope="col"><?php echo __('3 WORD PHRASES'); ?></th>
														<th scope="col"><?php echo __('Occurrences'); ?></th>
														<th scope="col"><?php echo __('Density'); ?></th>
														<th scope="col"><?php echo __('Possible Spam'); ?></th>
													</tr>
						...
						<div class="col-12">
							<div class="card card-primary">
								<div class="card-header">
									<h4><?php echo __('4 WORD PHRASES'); ?></h4>
									<div class="card-header-action">
									...
									<div class="card-body">
										<div class="table-responsive" <?php if(is_array($four_phrase) && count($four_phrase) > 0) echo 'style="height: 300px;"'?>>
											<table class="table table-hover table-striped table-bordered text-center">
												<thead class="thead-light thead-primary">
													<tr>
														<th scope="col"><?php echo __('4 WORD PHRASES'); ?></th>
														<th scope="col"><?php echo __('Occurrences'); ?></th>
														<th scope="col"><?php echo __('Density'); ?></th>
														<th scope="col"><?php echo __('Possible Spam'); ?></th>
													</tr>
