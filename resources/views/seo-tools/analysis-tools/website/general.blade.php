		...
		<div class="col-12 col-md-6">
			<div class="card card-hero custom_card-hero">
				<div class="card-header">
					...
					<div class="card-description">{{ __('WhoIs Information')}}</div>
				</div>
				...
				<div class="card-body p-0 whois-body">
					<div class="tickets-list">
						...
						<?php 
							...
							echo $col6_div_right_start.$title_start.__('Registered').$title_end;
							...
							echo $col6_div_left_start.$title_start.__('Domain Age').$title_end;
							echo $info_start.calculate_date_differece($end,$start).$info_end;
							// Domain Age end

							// Name Servers start
							echo $col12_div_start.$title_start.__('Name Servers').$title_end;
							...
							echo $col6_div_right_start.$title_start.__('Created At').$title_end;
							...
							echo $col6_div_left_start.$title_start.__('Changed At').$title_end;
							...
							echo $col6_div_right_start.$title_start.__('Expire At').$title_end;
							echo $info_start.$domain_info[0]->whois_expire_at.$info_end;
							// Expire At end

							// Registrant Url  start
							echo $col6_div_left_start.$title_start.__('Registrant Url').$title_end;
				...
				<div class="col-12">
					<div class="card card-hero custom_card-hero">
						<div class="card-header">
							...
							<div class="card-description">{{ __('MOZ Information')}}</div>
						</div>
						...
						<div class="card-body p-0 moz-body">
							<div class="tickets-list">
								...
								<?php 
									// is_registered start
									echo $col6_div_right_start.$title_start.__('Subdomain Normalized').$title_end;
									echo $info_start.$domain_info[0]->moz_subdomain_normalized.$info_end;
									// is_registered start

									// is_registered start
									echo $col6_div_left_start.$title_start.__('Subdomain Raw').$title_end;
									echo $info_start.$domain_info[0]->moz_subdomain_raw.$info_end;
									// is_registered start

									// is_registered start
									echo $col6_div_right_start.$title_start.__('URL Normalized').$title_end;
									echo $info_start.$domain_info[0]->moz_url_normalized.$info_end;
									// is_registered start

									// is_registered start
									echo $col6_div_left_start.$title_start.__('URL Raw').$title_end;
									echo $info_start.$domain_info[0]->moz_url_raw.$info_end;
									// is_registered start

									// is_registered start
									echo $col6_div_right_start.$title_start.__('HTTP Status Code').$title_end;
									echo $info_start.$domain_info[0]->moz_http_status_code.$info_end;
									// is_registered start

									// is_registered start
									echo $col6_div_left_start.$title_start.__('Domain Authority').$title_end;
									echo $info_start.$domain_info[0]->moz_domain_authority.$info_end;
									// is_registered start

									// is_registered start
									echo $col6_div_right_start.$title_start.__('Page Authority').$title_end;
									echo $info_start.$domain_info[0]->moz_page_authority.$info_end;
									// is_registered start

									// is_registered start
									echo $col6_div_left_start.$title_start.__('External Quality Link').$title_end;
									echo $info_start.$domain_info[0]->moz_external_equity_links.$info_end;
									// is_registered start

									// is_registered start
									echo $col6_div_right_start.$title_start.__('Links').$title_end;
	...
	<div class="row">
		<div class="col-12 col-md-6">
			...
			<div class="list-group">
				<a class="list-group-item list-group-item-action active text-white pointer"><i class="fas fa-link"></i> {{ __('Link Informations')}}
				</a>
				<a class="list-group-item d-flex justify-content-between align-items-center list-group-item-action pointer">
					{{ __('Total Link Count')}}
					<span class="badge badge-primary badge-pill">{{ $total_links}}</span>
				</a>
				<a class="list-group-item d-flex justify-content-between align-items-center list-group-item-action pointer">
					{{ __('BackLink Count')}}
					<span class="badge badge-primary badge-pill">{{ $domain_info[0]->google_back_link_count}}</span>
				</a>
				<a class="list-group-item d-flex justify-content-between align-items-center list-group-item-action pointer">
					{{ __('MozRank')}}
					<?php $domain_info[0]->moz_url_normalized = isset($domain_info[0]->moz_url_normalized) ? round((int)$domain_info[0]->moz_url_normalized) : 0 ?>
					<span class="badge badge-primary badge-pill">{{ round((int)$domain_info[0]->moz_url_normalized)."/10"}}</span>
				</a>
			</div>
		...
		<div class="col-12 col-md-6">
			<?php if ($domain_info[0]->screenshot != ""): ?>
				<img src='{{ $domain_info[0]->screenshot}}' class='img-responsive' style='border-radius: 0px;width:100%' />
			<?php else: ?>
				<div class="alert alert-warning alert-has-icon">
				  <div class="alert-icon"><i class="far fa-lightbulb"></i> </div>
				  <div class="alert-body" style="word-break: break-word">
				    <div class="alert-title"> {{ __("Warning")}}</div>
				    {{ isset($domain_info[0]->screenshot_error) ? $domain_info[0]->screenshot_error : ""}}<br>
				    <a target='_BLANK' href="https://console.developers.google.com/apis/library">{{ __("Enable Google PageInsights API from here")}}</a>
				  </div>
				</div>
			<?php endif?>
	...
	<div class="row">
		<div class="col-12">
			<div class="card card-primary">
				<div class="card-header">
					<h4><i class="fas fa-mobile-alt"></i> {{ __('Mobile Friendly Check')}}</h4>
				...
				<div class="card-body" id="mobile-collapse">
					...
					<?php if (empty($lighthouseresult_categories)): ?>
						<div class="alert alert-warning alert-has-icon">
						  ...
						  <div class="alert-body" style="word-break: break-word">
						    <div class="alert-title">{{ __("Warning")}}</div>
						    {{ isset($domain_info[0]->google_api_error) ? $domain_info[0]->google_api_error : ""}}<br>
						    <a target='_BLANK' href="https://console.developers.google.com/apis/library">{{ __("Enable Google PageInsights API from here")}}</a>
						  </div>
						</div>
					<?php else: ?>
							...
							<div class="row">
								<div class="col-12 col-md-6">						
									<p style="text-align: center;position: relative;">
									    <div style="display:inline;width:120px;height:120px;"><canvas width="120" height="120"></canvas><input type="text" class="dial knob" data-readonly="true" value="{{ $final_score}}" data-width="120" data-height="120" data-fgcolor="#6777ef" data-thickness=".1" readonly="readonly" style="width: 64px; height: 40px; position: absolute; vertical-align: middle; margin-top: 40px; margin-left: -92px; border: 0px; background: none; font: bold 24px Arial; text-align: center; color: rgb(103, 119, 239); padding: 0px; -webkit-appearance: none;"></div>
									</p>
									<h4 class="text-warning" style="margin-left: 21%">{{ __('Performance')}}</h4>
								</div>
								<div class="col-12 col-md-6">
									<li class="list-group-item d-flex justify-content-between align-items-center">
										{{ __("Emulated Form Factor")}}
						...
						<div class="row mt-5">
							<div class="col-12 col-md-8">
                                <div class="list-group">
                                    <a class="list-group-item list-group-item-action active text-white pointer"> {{ __('Field Data')}} <i data-description="<h2 class='section-title'>{{ __('Field Data')}}</h2> <p style='font-size: 12px;'>{{ __('Over the last 30 days, the field data shows that this page has an <b>Moderate</b> speed compared to other pages in the') }} <b><a target='_BLANK' href='https://developers.google.com/web/tools/chrome-user-experience-report/'></b> {{ __('Chrome User Experience Report') }}</a>. {{ __('We are showing') }} <b> <a target='_BLANK' href='https://developers.google.com/speed/docs/insights/v5/about#faq'>{{ __('the 75th percentile of FCP') }}</b> <b></a> and <a target='_BLANK' href='https://developers.google.com/speed/docs/insights/v5/about#faq'>{{ __('the 95th percentile of FID') }}</a></b></p>" class="fas fa-info-circle field_data_modal" style="color: #fff;"></i>
                                    </a>
                                    <a class="list-group-item d-flex justify-content-between align-items-center list-group-item-action pointer">
                                        {{ __('First Contentful Paint (FCP)')}}
                                        <span class="badge badge-primary badge-pill">
                                           <?php 
							...
							<div class="col-12 col-md-4 pl-4">
								<div style="padding-left:12px;min-height:530px;background: url('{{ asset("assets/images/mobile.png")}}') no-repeat !important;">
									<?php 
						...
						<div class="row mt-2">
							<div class="col-12 col-md-6">
                                <div class="list-group">
                                    <a class="list-group-item list-group-item-action active text-white pointer"> {{ __('Origin Summary')}} <i data-description="<h2 class='section-title'>{{ __('Origin Summary Data')}}</h2><p style='font-size: 12px;'> {{ __('All pages served from this origin have a <b>Slow</b> speed compared to other pages in the')}} <a target='_BLANK' href='https://developers.google.com/web/tools/chrome-user-experience-report/'>{{ __('Chrome User Experience Report') }}</a> {{ __('over the last 30 days.To view suggestions tailored to each page, analyze individual page URLs.') }}</p>" class="fas fa-info-circle field_data_modal" style="color: #fff;"></i>
                                    </a>
                                    <a class="list-group-item d-flex justify-content-between align-items-center list-group-item-action pointer">
                                        {{ __('First Contentful Paint (FCP)')}}
                                        <span class="badge badge-primary badge-pill">
							...
							<div class="col-12 col-md-6">
                                <div class="list-group">
                                    <a class="list-group-item list-group-item-action active text-white pointer"> {{ __('Lab Data')}} 
                                    </a>
                                    <a class="list-group-item d-flex justify-content-between align-items-center list-group-item-action pointer">
                                        {{ __('First Contentful Paint')}}<i data-description="<h2 class='section-title'>{{ __('First Contentful Paint')}}</h2> <p style='font-size: 12px;line-height: initial;'>{{ __('First Contentful Paint marks the time at which the first text or image is painted.')}} <b><a target='_BLANK' class='text-danger' href='https://web.dev/first-contentful-paint/?utm_source=lighthouse&utm_medium=unknown'>{{ __('Learn more')}}</a></b> </p>" class="fas fa-info-circle field_data_modal float-left" style="margin-right: 187px;"></i>
                                        <span class="badge badge-primary badge-pill">
                                            <?php 
                                    ...
                                    <a class="list-group-item d-flex justify-content-between align-items-center list-group-item-action pointer">
                                        {{ __('First Meaningful Paint')}}<i data-description="<h2 class='section-title'>{{ __('First Meaningful Paint')}}</h2>
                                            <p style='font-size: 12px;line-height: initial;'>{{ __('First Meaningful Paint measures when the primary content of a page is visible.')}} <b><a target='_BLANK' class='text-danger' href='https://web.dev/first-meaningful-paint?utm_source=lighthouse&utm_medium=unknown'>{{ __('Learn more')}}</a></b> </p>" class="fas fa-info-circle field_data_modal" style="margin-right: 187px;"></i>
                                        <span class="badge badge-primary badge-pill">
                                            <?php 
                                    ...
                                    <a class="list-group-item d-flex justify-content-between align-items-center list-group-item-action pointer">
                                        {{ __('Speed Index')}} <i data-description="<h2 class='section-title'>{{ __('Speed Index')}}</h2>
                                        <p style='font-size: 12px;line-height: initial;'>{{ __('Speed Index shows how quickly the contents of a page are visibly populated.')}} <b><a target='_BLANK' class='text-danger' href='https://web.dev/speed-index?utm_source=lighthouse&utm_medium=unknown'>{{ __('Learn more')}}</a></b> </p>" class="fas fa-info-circle field_data_modal" style="margin-right: 230px"></i>
                                        <span class="badge badge-primary badge-pill">
                                           <?php 
                                    ...
                                    <a class="list-group-item d-flex justify-content-between align-items-center list-group-item-action pointer">
                                        {{ __('First CPU Idle')}} <i data-description="<h2 class='section-title'>{{ __('First CPU Idle')}}</h2>
                                        <p style='font-size: 12px;line-height: initial;'>{{ __('First CPU Idle marks the first time at which the page main thread is quiet enough to handle input.')}} <b><a target='_BLANK' class='text-danger' href='https://web.dev/first-cpu-idle?utm_source=lighthouse&utm_medium=unknown'>{{ __('Learn more')}}</a></b> </p>" class="fas fa-info-circle field_data_modal" style="margin-right: 220px"></i>
                                        <span class="badge badge-primary badge-pill">
                                           <?php 
                                    ...
                                    <a class="list-group-item d-flex justify-content-between align-items-center list-group-item-action pointer">
                                        {{ __('Time to Interactive')}} <i class="fas fa-info-circle field_data_modal" style="margin-right: 187px;" data-description="<h2 class='section-title'>{{ __('Time to Interactive')}}</h2>
                                        <p style='font-size: 12px;line-height: initial;'>{{ __('Time to interactive is the amount of time it takes for the page to become fully interactive.')}} <b><a target='_BLANK' class='text-danger' href='https://web.dev/interactive/?utm_source=lighthouse&utm_medium=unknown'>{{ __('Learn more')}}</a></b> </p>"></i>
                                        <span class="badge badge-primary badge-pill">
                                            <?php 
                                    ...
                                    <a class="list-group-item d-flex justify-content-between align-items-center list-group-item-action pointer">
                                        {{ __('Max Potential First Input Delay')}} <i class="fas fa-info-circle field_data_modal" style="margin-right: 100px;" data-description="<h2 class='section-title'>{{ __('Max Potential First Input Delay')}}</h2>
                                            <p style='font-size: 12px;line-height: initial;'>{{ __('The maximum potential First Input Delay that your users could experience is the duration, in milliseconds, of the longest task.')}} <b><a target='_BLANK' class='text-danger' href='https://web.dev/fid/'>{{ __('Learn more')}}</a></b> </p>"></i>
                                        <span class="badge badge-primary badge-pill">
                                            <?php 
                                                    ...
                                                    <div class="ticket-item">
                                                        <div class="ticket-title" style="color:#6777ef;">
                                                            <h4>
                                                              ...
                                                              echo '<p style="font-size: 12px;line-height: initial;">'.$resource_sum[0].'<b><a class="text-danger" target="_BLANK" href="https://developers.google.com/web/tools/lighthouse/audits/budgets">'.__("Learn More").'</a></b></p>';
                                                              }
                                                    ...
                                                    <div class="ticket-item">
                                                        <div class="ticket-title" style="color:#6777ef;">
                                                            <h4>
                                                              ...
                                                              echo '<p style="font-size: 12px;line-height: initial;">'.$time_to_first_byte[0].'<b><a class="text-danger" target="_BLANK" href="https://web.dev/time-to-first-byte">'.__("Learn More").'</a></b></p>';
                                                              }
                                                    ...
                                                    <div class="ticket-item">
                                                        <div class="ticket-title" style="color:#6777ef;">
                                                            <h4>
                                                              ...
                                                              echo '<p style="font-size: 12px;line-height: initial;">'.$render_blocking[0].'<b><a class="text-danger" target="_BLANK" href="https://web.dev/render-blocking-resources">'.__("Learn More").'</a></b></p>';
                                                              }
                                                    ...
                                                    <div class="ticket-item">
                                                        <div class="ticket-title" style="color:#6777ef;">
                                                            <h4>
                                                              ...
                                                              echo '<p style="font-size: 12px;line-height: initial;">'.$optimizaed[0].'<b><a class="text-danger" target="_BLANK" href="https://web.dev/uses-optimized-images">'.__("Learn More").'</a></b></p>';
                                                              }
                                                    ...
                                                    <div class="ticket-item">
                                                        <div class="ticket-title" style="color:#6777ef;">
                                                            <h4>
                                                              ...
                                                              echo '<p style="font-size: 12px;line-height: initial;">'.$text_compresseion[0].'<b><a class="text-danger" target="_BLANK" href="https://web.dev/uses-text-compression">'.__("Learn More").'</a></b></p>';
                                                              }
                                                    ...
                                                    <div class="ticket-item">
                                                        <div class="ticket-title" style="color:#6777ef;">
                                                            <h4>
                                                              ...
                                                              echo '<p style="font-size: 12px;line-height: initial;">'.$uses_long_cache[0].'<b><a class="text-danger" target="_BLANK" href="https://web.dev/uses-long-cache-ttl">'.__("Learn More").'</a></b></p>';
                                                              }
                                                    ...
                                                    <div class="ticket-item">
                                                        <div class="ticket-title" style="color:#6777ef;">
                                                            <h4>
                                                              ...
                                                              echo '<p style="font-size: 12px;line-height: initial;">'.$third_party_summary[0].'<b><a class="text-danger" target="_BLANK" href="https://developers.google.com/web/fundamentals/performance/optimizing-content-efficiency/loading-third-party-javascript">'.__("Learn More").'</a></b></p>';
                                                              }
                                                    ...
                                                    <div class="ticket-item">
                                                        <div class="ticket-title" style="color:#6777ef;">
                                                            <h4>
                                                              ...
                                                              echo '<p style="font-size: 12px;line-height: initial;">'.$estimated_latency[0].'<b><a class="text-danger" target="_BLANK" href="https://web.dev/estimated-input-latency">'.__("Learn More").'</a></b></p>';
                                                              }
                                                    ...
                                                    <div class="ticket-item">
                                                        <div class="ticket-title" style="color:#6777ef;">
                                                            <h4>
                                                              ...
                                                              echo '<p style="font-size: 12px;line-height: initial;">'.$fcp3g[0].'<b><a class="text-danger" target="_BLANK" href="https://developers.google.com/web/tools/lighthouse/audits/first-contentful-paint">'.__("Learn More").'</a></b></p>';
                                                              }
                                                    ...
                                                    <div class="ticket-item">
                                                        <div class="ticket-title" style="color:#6777ef;">
                                                            <h4>
                                                              ...
                                                              echo '<p style="font-size: 12px;line-height: initial;">'.$boottime[0].'<b><a class="text-danger" target="_BLANK" href="https://web.dev/bootup-time">'.__("Learn More").'</a></b></p>';
                                                              }
                                                    ...
                                                    <div class="ticket-item">
                                                        <div class="ticket-title" style="color:#6777ef;">
                                                            <h4>
                                                              ...
                                                              echo '<p style="font-size: 12px;line-height: initial;">'.$offscreen_des[0].'<b><a class="text-danger" target="_BLANK" href="https://web.dev/offscreen-images">'.__("Learn More").'</a></b></p>';
                                                              }
                                                        ...
                                                        <div class="ticket-title" style="color:#6777ef;">
                                                            <h4>
                                                              ...
                                                              data-description="<?php
                                                                ...
                                                                echo "<p style='font-size: 12px;line-height: initial;'>{$network_server_lat[0]}<b><a class='text-danger' target='_BLANK' href='https://hpbn.co/primer-on-web-performance/#analyzing-the-resource-waterfall'>{__('Learn More')}</a></b></p>";
                                                                }
                                                        ...
                                                        <div class="ticket-title" style="color:#6777ef;">
                                                            <h4>
                                                              ...
                                                              data-description="<?php
                                                                ...
                                                                echo "<p style='font-size: 12px;line-height: initial;'>{$responsive[0]}<b><a class='text-danger' target='_BLANK' href='https://web.dev/uses-responsive-images?utm_source=lighthouse&utm_medium=unknown'>{__('Learn More')}</a></b></p>";
                                                                }
                                                        ...
                                                        <div class="ticket-title" style="color:#6777ef;">
                                                            <h4>
                                                              ...
                                                              data-description="<?php
                                                                ...
                                                                echo "<p style='font-size: 12px;line-height: initial;'>{$unused_css[0]}<b><a class='text-danger' target='_BLANK' href='https://web.dev/unused-css-rules'>{__('Learn More')}</a></b></p>";
                                                                }
                                                        ...
                                                        <div class="ticket-title" style="color:#6777ef;">
                                                            <h4>
                                                              ...
                                                              data-description="<?php
                                                                ...
                                                                echo "<p style='font-size: 12px;line-height: initial;'>{$total_byte[0]}<b><a class='text-danger' target='_BLANK' href='https://web.dev/total-byte-weight'>{__('Learn More')}</a></b></p>";
                                                                }
                                                        ...
                                                        <div class="ticket-title" style="color:#6777ef;">
                                                            <h4>
                                                              ...
                                                              data-description="<?php
                                                                ...
                                                                echo "<p style='font-size: 12px;line-height: initial;'>{$mainthred_work[0]}<b><a class='text-danger' target='_BLANK' href='https://web.dev/mainthread-work-breakdown'>{__('Learn More')}</a></b></p>";
                                                                }
                                                        ...
                                                        <div class="ticket-title" style="color:#6777ef;">
                                                            <h4>
                                                              ...
                                                              data-description="<?php
                                                                ...
                                                                echo "<p style='font-size: 12px;line-height: initial;'>{$uses_web_images[0]}<b><a class='text-danger' target='_BLANK' href='https://web.dev/uses-webp-images'>{__('Learn More')}</a></b></p>";
                                                                }
                                                        ...
                                                        <div class="ticket-title" style="color:#6777ef;">
                                                            <h4>
                                                              ...
                                                              data-description="<?php
                                                                ...
                                                                echo "<p style='font-size: 12px;line-height: initial;'>{$req_chain[0]}<b><a class='text-danger' target='_BLANK' href='https://web.dev/critical-request-chains'>{__('Learn More')}</a></b></p>";
                                                                }
                                                        ...
                                                        <div class="ticket-title" style="color:#6777ef;">
                                                            <h4>
                                                              ...
                                                              data-description="<?php
                                                                ...
                                                                echo "<p style='font-size: 12px;line-height: initial;'>{$dom_size1[0]}<b><a class='text-danger' target='_BLANK' href='https://developers.google.com/web/fundamentals/performance/rendering/reduce-the-scope-and-complexity-of-style-calculations'>{__('Learn More')}</a></b></p>";
                                                                }
                                                        ...
                                                        <div class="ticket-title" style="color:#6777ef;">
                                                            <h4>
                                                              ...
                                                              data-description="<?php
                                                                ...
                                                                echo "<p style='font-size: 12px;line-height: initial;'>{$redirects_des[0]}<b><a class='text-danger' target='_BLANK' href='https://web.dev/redirects'>{__('Learn More')}</a></b></p>";
                                                                }
                                                        ...
                                                        <div class="ticket-title" style="color:#6777ef;">
                                                            <h4>
                                                              ...
                                                              data-description="<?php
                                                                ...
                                                                echo "<p style='font-size: 12px;line-height: initial;'>{$unminified_js[0]}<b><a class='text-danger' target='_BLANK' href='https://web.dev/unminified-javascript'>{__('Learn More')}</a></b></p>";
                                                                }
                                                        ...
                                                        <div class="ticket-title" style="color:#6777ef;">
                                                            <h4>
                                                              ...
                                                              data-description="<?php
                                                                ...
                                                                echo "<p style='font-size: 12px;line-height: initial;'>{$user_times[0]}<b><a class='text-danger' target='_BLANK' href='https://web.dev/user-timings'>{__('Learn More')}</a></b></p>";
                                                                }
                                                        ...
                                                        <div class="ticket-title" style="color:#6777ef;">
                                                            <h4>
                                                              ...
                                                              data-description="<?php
                                                                ...
                                                                echo "<p style='font-size: 12px;line-height: initial;'>{$network_rtt[0]}<b><a class='text-danger' target='_BLANK' href='https://hpbn.co/primer-on-latency-and-bandwidth/'>{__('Learn More')}</a></b></p>";
                                                                }
	...
	<div class="row mb-5">
		<div class="col-12 col-md-6">
			...
			<ul class="list-group ip-info">
				<li class="list-group-item bg-primary text-white border-0"><i class="fas fa-map-marker-alt"></i>&nbsp; {{ __('IP Information')}}
				</li>

				<li class="list-group-item"><b><i class="fas fa-asterisk text-primary"></i>&nbsp; {{ __('ISP')}} : </b>
					{{ $domain_info[0]->ipinfo_isp}}
				</li>
				<li class="list-group-item"><b><i class="fas fa-asterisk text-primary"></i>&nbsp; {{ __('IP')}} : </b>
					{{ $domain_info[0]->ipinfo_ip}}
				</li>
				<li class="list-group-item"><b><i class="fas fa-asterisk text-primary"></i>&nbsp; {{ __('Country')}} : </b>
					<?php 
						$ipinfo_country = isset($domain_info[0]->ipinfo_country) ? $domain_info[0]->ipinfo_country : '';
						$x = trim(strtoupper($ipinfo_country));
					?>
					<img style="height: 15px; width: 15px; margin-top: -3px;" alt=" " src="<?php $s_country = array_search($x, $country_list); echo asset('assets/images/flags/'.$s_country.'.png')?>">&nbsp;{{ $x}}
				</li>
				<li class="list-group-item"><b><i class="fas fa-asterisk text-primary"></i>&nbsp; {{ __('City')}} : </b>
					{{ $domain_info[0]->ipinfo_city}}
				</li>
				<li class="list-group-item"><b><i class="fas fa-asterisk text-primary"></i>&nbsp; {{ __('Region')}} : </b>
					{{ $domain_info[0]->ipinfo_region}}
				</li>
				<li class="list-group-item"><b><i class="fas fa-asterisk text-primary"></i>&nbsp; {{ __('Timezone')}} : </b>
					{{ $domain_info[0]->ipinfo_time_zone}}
				</li>
				<li class="list-group-item"><b><i class="fas fa-asterisk text-primary"></i>&nbsp; {{ __('Latitude')}} : </b>
					{{ $domain_info[0]->ipinfo_latitude}}
				</li>
				<li class="list-group-item"><b><i class="fas fa-asterisk text-primary"></i>&nbsp; {{ __('Longitude')}} : </b>
					{{ $domain_info[0]->ipinfo_longitude}}
				</li>
			</ul>
		</div>
		...
		<div class="col-12 col-md-6">
			...
			<ul class="list-group mb-5 search_engine_index">
				<li class="list-group-item bg-info text-white border-0"><i class="fa fa-sort-numeric-asc"></i> {{ __('Search Engine Index Info')}}</li>
				<li class="list-group-item"><b><i class="fab fa-google text-info"></i>&nbsp; 
					{{ __('Google Index')}}</b> : {{ $domain_info[0]->google_index_count}}
				</li>
				<li class="list-group-item"><b><i class="fab fa-windows text-info"></i>&nbsp; 
					{{ __('Bing Index')}}</b> : {{ $domain_info[0]->bing_index_count}}
				</li>
				<li class="list-group-item"><b><i class="fab fa-yahoo text-info"></i>&nbsp; 
					{{ __('Yahoo Index')}}</b> : {{ $domain_info[0]->yahoo_index_count}}
				</li>
			</ul>
			
			<!-- Malware Scan Info -->
			<ul class="list-group">
				<li class="list-group-item bg-danger text-white border-0"><i class="fa fa-shield"></i> {{ __('Malware Scan Info')}}</li>
				<li class="list-group-item"><b><i class="fab fa-google text-danger"></i>&nbsp; 
					{{ __('Google Safe Browser')}}</b> : {{ $domain_info[0]->google_safety_status}}
				</li>
				<li class="list-group-item"><b><i class="fa fa-shield text-danger"></i>&nbsp; 
					{{ __('Norton')}}</b> : {{ $domain_info[0]->norton_status}}
				</li>
				<li class="list-group-item"><b><i class="fab fa-typo3 text-danger"></i>&nbsp; 
					{{ __('Mcafee')}}</b> : {{ $domain_info[0]->macafee_status}}
				</li>
			</ul>
		</div>
	</div>
		...
		<div class="col-12 col-md-6">
			<div class="card card-hero custom_card-hero">
				<div class="card-header">
					...
					<div class="card-description">{{ __('Sites in Same IP')}}</div>
				</div>
		...
		<div class="col-12 col-md-6">
			<div class="card card-hero custom_card-hero">
				<div class="card-header">
					...
					<div class="card-description">{{ __('Related Websites')}}</div>
				</div>
				<div class="card-body p-0">
					<div class="tickets-list">
						<div class="tickets-list">
							<div class="row">
								<?php 
									if(isset($domain_info[0]->similar_sites) && $domain_info[0]->similar_sites!= '')
										...
										$similar_sites = explode(',', $domain_info[0]->similar_sites);
									else
										$similar_sites = [];
									...
									if(is_array($similar_sites) && !empty($similar_sites)){
										...
										echo "<div class='col-12'><div class='text-center h5 p-3'>".__('No data to show')."</div></div>";
									}
								?>
							</div>
						</div>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title"> <i class="fab fa-google"></i> {{ __("Google PageSpeed Insights")}}</h5>
      ...
      <div class="modal-footer text-center">
              <a class="btn btn-outline-secondary" data-dismiss="modal"><i class="fas fa-times"></i> {{ __("Close") }}</a>
      </div>
    </div>
  </div>
</div>
