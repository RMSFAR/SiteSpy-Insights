...
<div class="container-fluid">
	...
	<div class="row">
		<div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
			<div class="info-box">
				...
				<div class="info-box-content">
					<span class="info-box-text">{{ __('Domain Name')}}</span>
					<span id="total_unique_visitor" class="info-box-number">{{ $domain}}</span>
		...
		<div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
			<div style="border:1px solid #fff;border-bottom:2px solid #fff;" class="info-box">
				...
				<div class="info-box-content">
					<span class="info-box-text">{{ __('Global Rank')}}</span>
					<span id="total_unique_visitor" class="info-box-number">{{ $global_rank}}</span>
				</div><!-- /.info-box-content -->
			</div>
		</div>	
		...
		<div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
			<div style="border:1px solid #F39C12;border-bottom:2px solid #F39C12;" class="info-box">
				...
				<div class="info-box-content">
					<span class="info-box-text">{{ __('Top Country Rank')}}</span>
					<span id="total_unique_visitor" class="info-box-number">{{ $country}} - {{ $country_rank}}</span>
				</div><!-- /.info-box-content -->
			</div>
		</div>		
	</div>
	...
	<div class="row">
		<div class="col-xs-12 col-sm-12 col-md-5 col-lg-5">
			<div class="box box-primary">
				<div class="box-header with-border">
					<h3 style="color: blue; word-spacing: 5px;" class="box-title">{{ __('Alexa Traffic Ranks')}}</h3>
		...
		<div class="col-xs-12 col-sm-12 col-md-7 col-lg-7">
			<div class="box box-primary">
				<div class="box-header with-border">
					<h3 style="color: blue; word-spacing: 5px;" class="box-title">{{ __('Visitors per Country')}}</h3>
					<div class="box-tools pull-right">
						<button data-widget="collapse" class="btn btn-box-tool"><i class="fa fa-minus"></i></button>
						<button data-widget="remove" class="btn btn-box-tool"><i class="fa fa-times"></i></button>
					</div>
	...
	<div class="row">
		<div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
			<div class="info-box bg-blue">
				...
				<div class="info-box-content">
					...
					<span class="info-box-number">{{ $page_view_per_visitor}}</span>
					<div class="progress">
						<div style="width: 70%" class="progress-bar"></div>
					</div>
					<span class="progress-description">
						{{ __('Daily Page View per Visitor')}}
					</span>
				</div><!-- /.info-box-content -->
			</div>
		</div>
		...
		<div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
			<div class="info-box bg-green">
				...
				<div class="info-box-content">
					<!-- <span class="info-box-text">Inventory</span> -->
					<span class="info-box-number">{{ $daily_time_on_the_site}}</span>
					<div class="progress">
						<div style="width: 70%" class="progress-bar"></div>
					</div>
					<span class="progress-description">
						{{ __('Daily Time on Site')}}
					</span>
				</div><!-- /.info-box-content -->
			</div>
		</div>
		...
		<div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
			<div class="info-box bg-yellow">
				...
				<div class="info-box-content">
					<!-- <span class="info-box-text">Inventory</span> -->
					<span class="info-box-number">{{ $visitor_percent_from_searchengine}}</span>
					<div class="progress">
						<div style="width: 70%" class="progress-bar"></div>
					</div>
					<span class="progress-description">
						{{ __('Visitor % from Search Engines')}}
					</span>
				</div><!-- /.info-box-content -->
			</div>
		</div>
	...
	<div class="row">		
		<div class="col-xs-12 col-sm-12 col-md-7 col-lg-7">
			<div class="box box-primary">
				<div class="box-header with-border">
					<h3 style="color: blue; word-spacing: 5px;" class="box-title">{{ __('Top Keywords from Search Engines')}}</h3>
					<div class="box-tools pull-right">
						<button data-widget="collapse" class="btn btn-box-tool"><i class="fa fa-minus"></i></button>
						<button data-widget="remove" class="btn btn-box-tool"><i class="fa fa-times"></i></button>
					</div>
		...
		<div class="col-xs-12 col-sm-12 col-md-5 col-lg-5">
			<div class="box box-primary">
				<div class="box-header with-border">
					<h3 style="color: blue; word-spacing: 5px;" class="box-title">{{ __('Search Traffic')}}</h3>
					<div class="box-tools pull-right">
						<button data-widget="collapse" class="btn btn-box-tool"><i class="fa fa-minus"></i></button>
						<button data-widget="remove" class="btn btn-box-tool"><i class="fa fa-times"></i></button>
					</div>
	...
	<div class="row">
		<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
			<div class="small-box bg-green">
				<div class="inner">
					<h3><span id="average_stay_time">{{ $total_site_linking_in}}</span></h3>
					{{ __('Total Linking In Site')}}
				</div>
				<div class="icon">
		...
		<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
			<div class="small-box bg-red">
				<div class="inner">
					<h3><span id="average_stay_time">{{ $bounce_rate}}</span></h3>
					{{ __('Bounce Rate')}}
				</div>
				<div class="icon">
					<i class="fa fa-clock-o"></i>
	...
	<div class="col-xs-12">
		<div class="box box-primary">
				<div class="box-header with-border">
					<h3 style="color: blue; word-spacing: 5px;" class="box-title"> {{ __('Linking In Statistics')}}</h3>
					<div class="box-tools pull-right">
						<button data-widget="collapse" class="btn btn-box-tool"><i class="fa fa-minus"></i></button>
						<button data-widget="remove" class="btn btn-box-tool"><i class="fa fa-times"></i></button>
					</div>
	...
	<div class="row">
		<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
			<div class="box box-primary">
				<div class="box-header with-border">
					<h3 style="color: blue; word-spacing: 5px;" class="box-title">{{ __('Upstream Sites')}}</h3>
					<div class="box-tools pull-right">
						<button data-widget="collapse" class="btn btn-box-tool"><i class="fa fa-minus"></i></button>
						<button data-widget="remove" class="btn btn-box-tool"><i class="fa fa-times"></i></button>
					</div>
		...
		<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
			<div class="box box-primary">
				<div class="box-header with-border">
					<h3 style="color: blue; word-spacing: 5px;" class="box-title">{{ __('Subdomain Statistics')}}</h3>
					<div class="box-tools pull-right">
						<button data-widget="collapse" class="btn btn-box-tool"><i class="fa fa-minus"></i></button>
						<button data-widget="remove" class="btn btn-box-tool"><i class="fa fa-times"></i></button>
					</div>
