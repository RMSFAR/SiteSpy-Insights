@php 
	...
	echo "<title>".$domain_info[0]->domain_name." ".__('Anlaysis Report')." | ".config("app.product_name")."</title>";
	echo "<link rel='shortcut icon' href=".config('my_config.favicon')."";
@endphp

@include("seo-tools.analysis-tools.website.report.report-css-js");


@php
	echo "</head><body><div class='row'>";

	$path = config('my_config.logo');
	$type = pathinfo($path, PATHINFO_EXTENSION);
	$data = file_get_contents($path);
	$base64 = 'data:image/' . $type . ';base64,' . base64_encode($data);
	echo "<div class='text-center'><img style='width:200px;' src='".$base64."' alt='".config("my_config.institute_address1")."'></div>";
	echo "<h3 class='text-center'>".config("my_config.institute_address1")."</h3>";
	if(config("my_config.institute_address2")!="")
	echo "<h6 class='text-center'>Address: ".config("my_config.institute_address2")."</h6>";
	echo "<h6 class='text-center'>Contact: ".config("my_config.institute_email");
	echo " | ".config("my_config.institute_mobile");
	echo "</h6><h6 class='text-center'>Website: <a href=".url('/')." target='_BLANK'>".url('/')."</a></h6>";
...
<div id="hide_after_ajax">
	...
	<div class="row">
		<div class="col-md-6" style="float: left;">
			<ul class="list-group pdf-list-group">
				<li class="list-group-item pdf-list-group-item-active"><?php echo __('WhoIs Information'); ?></li>  

				<li class="list-group-item"><b><?php echo __('Registered'); ?> : </b>
					<?php 
						if($domain_info[0]->whois_is_registered == 'yes') $is_registered = __('Yes'); 
						else $is_registered = __('No');

						echo $is_registered; ?>
				</li>

				<li class="list-group-item"><b><?php echo __('Domain Age'); ?> : </b>
					<?php
				...
				<li class="list-group-item"><b><?php echo __('Tech Email'); ?> : </b>
					<?php echo $domain_info[0]->whois_tech_email; ?>
				</li>

				<li class="list-group-item"><b><?php echo __('Name Servers'); ?> : </b>
					<?php echo $domain_info[0]->whois_name_servers; ?>
				</li>

				<li class="list-group-item"><b><?php echo __('Created At'); ?> : </b>
					<?php if($domain_info[0]->whois_created_at != '0000-00-00') echo date("d-M-Y",strtotime($domain_info[0]->whois_created_at)); ?>
				</li>
				<li class="list-group-item"><b><?php echo __('Changed At'); ?> : </b>
					<?php if($domain_info[0]->whois_changed_at != '0000-00-00') echo date("d-M-Y",strtotime($domain_info[0]->whois_changed_at)); ?>
				</li>
				<li class="list-group-item"><b><?php echo __('Expire At'); ?> : </b>
					<?php if($domain_info[0]->whois_expire_at != '0000-00-00') echo date("d-M-Y",strtotime($domain_info[0]->whois_expire_at)); ?>
				</li>

				<li class="list-group-item"><b><?php echo __('Registrant Name'); ?> : </b>
					<?php echo $domain_info[0]->whois_registrant_name; ?>
				</li>
				<li class="list-group-item"><b><?php echo __('Admin Name'); ?> : </b>
					<?php echo $domain_info[0]->whois_admin_name ; ?>
				</li>

				<li class="list-group-item"><b><?php echo __('Registrant Country'); ?> : </b>
					<img style="height: 15px; width: 20px; margin-top: -3px;" alt=" " src="<?php echo asset('assets/images/flags/'.$domain_info[0]->whois_registrant_country.'.png') ?>" >&nbsp;<?php echo $domain_info[0]->whois_registrant_country; ?>
				</li>
				
				<li class="list-group-item"><b><?php echo __('Admin Country'); ?> : </b>
					<img style="height: 15px; width: 20px; margin-top: -3px;" alt=" " src="<?php echo asset('assets/images/flags/'.$domain_info[0]->whois_admin_country.'.png') ?>" >&nbsp;<?php echo $domain_info[0]->whois_admin_country; ?>
				</li>
				
				<li class="list-group-item"><b><?php echo __('Registrant Phone'); ?> : </b>
					<?php echo $domain_info[0]->whois_registrant_phone; ?>
				</li>
				
				<li class="list-group-item"><b><?php echo __('Admin Phone'); ?> : </b>
		...
		<div class="col-md-6" style="float: right;">
			<ul class="list-group pdf-list-group">
				<li class="list-group-item pdf-list-group-item-active"><?php echo __('MOZ Information'); ?></li>
				<li class="list-group-item">
					<b><?php echo __('Subdomain Normalized'); ?> : </b>
					<?php echo $domain_info[0]->moz_subdomain_normalized; ?>
				</li>
				<li class="list-group-item">
					<b><?php echo __('Subdomain Raw'); ?> : </b>
					<?php echo $domain_info[0]->moz_subdomain_raw; ?>
				</li>
				<li class="list-group-item">
					<b><?php echo __('URL Normalized'); ?> : </b>
					<?php echo $domain_info[0]->moz_url_normalized; ?>
				</li>
				<li class="list-group-item">
					<b><?php echo __('URL Raw'); ?> : </b>
					<?php echo $domain_info[0]->moz_url_raw; ?>
				</li>
				<li class="list-group-item">
					<b><?php echo __('HTTP Status Code'); ?> : </b>
					<?php echo $domain_info[0]->moz_http_status_code; ?>
				</li>
				<li class="list-group-item">
					<b><?php echo __('Domain Authority'); ?> : </b>
					<?php echo $domain_info[0]->moz_domain_authority; ?>
				</li>
				<li class="list-group-item">
					<b><?php echo __('Page Authority'); ?> : </b>
					<?php echo $domain_info[0]->moz_page_authority; ?>
				</li>
				<li class="list-group-item">
					<b><?php echo __('External Quality Link'); ?> : </b>
					<?php echo $domain_info[0]->moz_external_equity_links; ?>
				</li>
				<li class="list-group-item">
					<b><?php echo __('Links'); ?> : </b>
					<?php echo $domain_info[0]->moz_links; ?>
				</li>
			</ul>

			<ul class="list-group pdf-list-group">
				<li class="list-group-item pdf-list-group-item-active"><?php echo __('Link Information'); ?></li>
				<li class="list-group-item">
					<b><?php echo __('BackLink Count'); ?> : </b>
					<?php echo $domain_info[0]->google_back_link_count; ?>
				</li>
				<li class="list-group-item">
					<b><?php echo __('Total Link Count'); ?> : </b>
					<?php 
	...
	<div class="row">
		<div class="card" style="box-shadow: none;margin-top:10px;">
			<div class="card-header" style="border-bottom: 1px solid #f1f1f1; text-align: left;background-color: #007bff;">
				<h4 style="color: #fff;"><?php echo __('Mobile Friendly Check'); ?></h4>
			</div>
			...
			<?php else: ?>
				<ul class="list-group">
					<div class="row">
						<div class="col-12">						
								<h4><?php echo __('Performance'); ?> : <?php echo $final_score; ?></h4>
						</div>
					</div>
					<div class="row">
						<div class="col-12">
				...
				<div class="row mt-5">
					<div class="col-12 col-md-8">
						<div class="card card-hero custom_card-hero">
						    <div class="card-header" style="background-color: #007bff;">
						        ...
						        <h4 style="color: #fff;"><?php echo __('Field Data'); ?></h4>
						        <div class="card-description">
									<p style="font-size: 12px; color: #fff;"><?php echo __("Over the last 30 days, the field data shows that this page has an <b>Moderate</b> speed compared to other pages in the") ?> <b><a target="_BLANK" style="color: #fff;" href="https://developers.google.com/web/tools/chrome-user-experience-report/"></b> <?php echo __("Chrome User Experience Report") ?></a>. <?php echo __("We are showing") ?> <b> <a style="color: #fff;" target="_BLANK"  href="https://developers.google.com/speed/docs/insights/v5/about#faq"><?php echo __("the 75th percentile of FCP") ?></b> <b></a> and <a target="_BLANK" style="color: #fff;" href="https://developers.google.com/speed/docs/insights/v5/about#faq"><?php echo __("the 95th percentile of FID") ?></a></b></p>
						        </div>
						        ...
						        <div class="tickets-list">
						                ...
						                <div class="col-12  pr-0">
						                    <a class="ticket-item">
						                        <div class="ticket-title" style="color:#6777ef;">
						                            <h4 style="font-size:14px;"><?php echo __("First Contentful Paint (FCP)"); ?></h4>
						                        </div>
						                    ...
						                    <a class="ticket-item">
						                        <div class="ticket-title" style="color:#6777ef;">
						                            <h4 style="font-size:14px;"><?php echo __("Metric Category"); ?></h4>
						                        </div>
						                        <div class="ticket-info" style="word-break:break-all;font-size:11px;color: #6777ef">
						                            <div>
						                            	<?php 
						            ...
						            <div class="row">								                
						                <div class="col-12  pr-0">
						                    <a class="ticket-item">
						                        <div class="ticket-title" style="color:#6777ef;">
						                            <h4 style="font-size:14px;"><?php echo __("First Input Delay (FID)"); ?></h4>
						                        </div>
						                        <div class="ticket-info" style="word-break:break-all;font-size:11px;color: #6777ef">
						                            <div>								                <?php 
						            ...
						            <div class="row">
						            	<div class="col-12 pr-0">
						            		<a class="ticket-item ticket-item ticket-more">
						            		    <div class="ticket-title" style="color:#6777ef;">
						            		        <h4 style="font-size:14px;"><?php echo __("Overall Category "); ?></h4>
						            		    </div>
                    ...
                    <div class="col-12 col-md-4">
                        <div style="height:530px;background: url('<?php echo asset("assets/images/mobile.png");?>') no-repeat !important;text-align: center;background-position: top center;">
                            <?php
					...
					<div class="col-12">
						<div class="card card-hero custom_card-hero">
						    <div class="card-header" style="background-color: #007bff;">
						        ...
						        <h4 style="color: #fff;"><?php echo __('Origin Summary'); ?></h4>
						        <div class="card-description">
									<p style="font-size: 12px;color: #fff;"> <?php echo __("All pages served from this origin have a <b>Slow</b> speed compared to other pages in the"); ?> <a target="_BLANK" style="color: #fff" href="https://developers.google.com/web/tools/chrome-user-experience-report/"><?php echo __("Chrome User Experience Report") ?></a> <?php echo __("over the last 30 days.To view suggestions tailored to each page, analyze individual page URLs.") ?></p>
						        </div>
					...
					<div class="col-12">
						<div class="card card-hero custom_card-hero">
						    <div class="card-header" style="background-color: #007bff">
						        ...
						        <h4 style="color: #fff;"><?php echo __('Lab Data'); ?></h4>
						        ...
						        <div class="tickets-list">
						            <div class="row">
						                <div class="col-12  pr-0">
						                    <div class="ticket-item">
						                        <div class="ticket-title" style="color:#6777ef;">
						                            <h4 style="font-size:14px;"><?php echo __("First Contentful Paint"); ?></h4>
						                            <p style="font-size: 12px;line-height: initial;"><?php echo __("First Contentful Paint marks the time at which the first text or image is painted."); ?> <b><a target="_BLANK" class="text-danger" href="https://web.dev/first-contentful-paint/?utm_source=lighthouse&utm_medium=unknown"><?php echo __("Learn more"); ?></a></b> </p>
						                        </div>
						            ...
						            <div class="row">						                
						                <div class="col-12 pr-0">
						                    <div class="ticket-item">
						                        <div class="ticket-title" style="color:#6777ef;">
						                            <h4 style="font-size:14px;"><?php echo __("First Meaningful Paint"); ?></h4>
						                            <p style="font-size: 12px;line-height: initial;"><?php echo __("First Meaningful Paint measures when the primary content of a page is visible."); ?> <b><a target="_BLANK" class="text-danger" href="https://web.dev/first-meaningful-paint?utm_source=lighthouse&utm_medium=unknown"><?php echo __("Learn more"); ?></a></b> </p>
						                        </div>
						                        <div class="ticket-info" style="word-break:break-all;font-size:11px;">
						                            <div>								                <?php 
						            ...
						            <div class="row">                                            
                                        <div class="col-12  pr-0">
                                            <div class="ticket-item">
                                                <div class="ticket-title" style="color:#6777ef;">
                                                    <h4 style="font-size:14px;"><?php echo __("Speed Index"); ?></h4>
                                                    <p style="font-size: 12px;line-height: initial;"><?php echo __("Speed Index shows how quickly the contents of a page are visibly populated."); ?> <b><a target="_BLANK" class="text-danger" href="https://web.dev/speed-index?utm_source=lighthouse&utm_medium=unknown"><?php echo __("Learn more"); ?></a></b> </p>
                                                </div>
                                                <div class="ticket-info" style="word-break:break-all;font-size:11px;">
                                                    <div>                                               <?php 
                                    ...
                                    <div class="row">                                              
                                        <div class="col-12  pr-0">
                                            <div class="ticket-item">
                                                <div class="ticket-title" style="color:#6777ef;">
                                                    <h4 style="font-size:14px;"><?php echo __("First CPU Idle"); ?></h4>
                                                    <p style="font-size: 12px;line-height: initial;"><?php echo __("First CPU Idle marks the first time at which the page's main thread is quiet enough to handle input."); ?> <b><a target="_BLANK" class="text-danger" href="https://web.dev/first-cpu-idle?utm_source=lighthouse&utm_medium=unknown"><?php echo __("Learn more"); ?></a></b> </p>
                                                </div>
                                                <div class="ticket-info" style="word-break:break-all;font-size:11px;">
                                                    <div>                                               <?php 
                                    ...
                                    <div class="row">                                                   
                                        <div class="col-12  pr-0">
                                            <div class="ticket-item">
                                                <div class="ticket-title" style="color:#6777ef;">
                                                    <h4 style="font-size:14px;"><?php echo __("Time to Interactive"); ?></h4>
                                                    <p style="font-size: 12px;line-height: initial;"><?php echo __("Time to interactive is the amount of time it takes for the page to become fully interactive."); ?> <b><a target="_BLANK" class="text-danger" href="https://web.dev/interactive/?utm_source=lighthouse&utm_medium=unknown"><?php echo __("Learn more"); ?></a></b> </p>
                                                </div>
                                                <div class="ticket-info" style="word-break:break-all;font-size:11px;">
                                                    <div>                                               <?php 
                                    ...
                                    <div class="row">                                                  
                                        <div class="col-12  pr-0">
                                            <div class="ticket-item">
                                                <div class="ticket-title" style="color:#6777ef;">
                                                    <h4 style="font-size:14px;"><?php echo __("Max Potential First Input Delay"); ?></h4>
                                                    <p style="font-size: 12px;line-height: initial;"><?php echo __("The maximum potential First Input Delay that your users could experience is the duration, in milliseconds, of the longest task."); ?> <b><a target="_BLANK" class="text-danger" href="https://web.dev/fid/"><?php echo __("Learn more"); ?></a></b> </p>
                                                </div>
                                                <div class="ticket-info" style="word-break:break-all;font-size:11px;">
                                                    <div>                                               <?php 
                    ...
                    <div class="col-12">
                        <div class="card card-hero custom_card-hero">
                            <div class="card-header" style="background-color: #007bff">
                                ...
                                <h4 style="color: #fff;"><?php echo __('Audit Data'); ?></h4>
                                                         ...
                                                         <?php 
                                                          ...
                                                          if(isset($lighthouseresult_audits['resource-summary']['description'])){
                                                            ...
                                                            $resource_sum = explode('[',$lighthouseresult_audits['resource-summary']['description']);
                                                             echo $resource_sum[0] .'<b><a class="text-danger" target="_BLANK" href="https://developers.google.com/web/tools/lighthouse/audits/budgets">'.__("Learn More").'</a></b>';
                                                          }
                                                         ...
                                                         <?php 
                                                          ...
                                                          if(isset($lighthouseresult_audits['time-to-first-byte']['description'])){
                                                            ...
                                                            $time_to_first_byte = explode('[',$lighthouseresult_audits['time-to-first-byte']['description']);
                                                             echo $time_to_first_byte[0] .'<b><a class="text-danger" target="_BLANK" href="https://web.dev/time-to-first-byte">'.__("Learn More").'</a></b>';
                                                          }
                                                         ...
                                                         <?php 
                                                          ...
                                                          if(isset($lighthouseresult_audits['render-blocking-resources']['description'])){
                                                            ...
                                                            $render_blocking = explode('[',$lighthouseresult_audits['render-blocking-resources']['description']);
                                                             echo $render_blocking[0] .'<b><a class="text-danger" target="_BLANK" href="https://web.dev/render-blocking-resources">'.__("Learn More").'</a></b>';
                                                          }
                                                         ...
                                                         <?php 
                                                          ...
                                                          if(isset($lighthouseresult_audits['uses-optimized-images']['description'])){
                                                            ...
                                                            $optimizaed = explode('[',$lighthouseresult_audits['uses-optimized-images']['description']);
                                                             echo $optimizaed[0] .'<b><a class="text-danger" target="_BLANK" href="https://web.dev/uses-optimized-images">'.__("Learn More").'</a></b>';
                                                          }
                                                         ...
                                                         <?php 
                                                          ...
                                                          if(isset($lighthouseresult_audits['uses-text-compression']['description'])){
                                                            ...
                                                            $text_compresseion = explode('[',$lighthouseresult_audits['uses-text-compression']['description']);
                                                             echo $text_compresseion[0] .'<b><a class="text-danger" target="_BLANK" href="https://web.dev/uses-text-compression">'.__("Learn More").'</a></b>';
                                                          }
                                                         ...
                                                         <?php 
                                                          ...
                                                          if(isset($lighthouseresult_audits['uses-long-cache-ttl']['description'])){
                                                            ...
                                                            $uses_long_cache = explode('[',$lighthouseresult_audits['uses-long-cache-ttl']['description']);
                                                             echo $uses_long_cache[0] .'<b><a class="text-danger" target="_BLANK" href="https://web.dev/uses-long-cache-ttl">'.__("Learn More").'</a></b>';
                                                          }
                                                         ...
                                                         <?php 
                                                          ...
                                                          if(isset($lighthouseresult_audits['third-party-summary']['description'])){
                                                            ...
                                                            $third_party_summary = explode('[',$lighthouseresult_audits['third-party-summary']['description']);
                                                             echo $third_party_summary[0] .'<b><a class="text-danger" target="_BLANK" href="https://developers.google.com/web/fundamentals/performance/optimizing-content-efficiency/loading-third-party-javascript">'.__("Learn More").'</a></b>';
                                                          }
                                                         ...
                                                         <?php 
                                                          ...
                                                          if(isset($lighthouseresult_audits['network-rtt']['description'])){
                                                            ...
                                                            $newtwork_rtt = explode('[',$lighthouseresult_audits['network-rtt']['description']);
                                                             echo $newtwork_rtt[0] .'<b><a class="text-danger" target="_BLANK" href="https://hpbn.co/primer-on-latency-and-bandwidth">'.__("Learn More").'</a></b>';
                                                          }
                                                         ...
                                                         <?php 
                                                          ...
                                                          if(isset($lighthouseresult_audits['estimated-input-latency']['description'])){
                                                            ...
                                                            $estimated_latency = explode('[',$lighthouseresult_audits['estimated-input-latency']['description']);
                                                             echo $estimated_latency[0] .'<b><a class="text-danger" target="_BLANK" href="https://web.dev/estimated-input-latency">'.__("Learn More").'</a></b>';
                                                          }
                                                         ...
                                                         <?php 
                                                          ...
                                                          if(isset($lighthouseresult_audits['first-contentful-paint-3g']['description'])){
                                                            ...
                                                            $estimated_latency = explode('[',$lighthouseresult_audits['first-contentful-paint-3g']['description']);
                                                             echo $estimated_latency[0] .'<b><a class="text-danger" target="_BLANK" href="https://developers.google.com/web/tools/lighthouse/audits/first-contentful-paint">'.__("Learn More").'</a></b>';
                                                          }
                                                         ...
                                                         <?php 
                                                          ...
                                                          if(isset($lighthouseresult_audits['bootup-time']['description'])){
                                                            ...
                                                            $total_blocking_time = explode('[',$lighthouseresult_audits['bootup-time']['description']);
                                                             echo $total_blocking_time[0] .'<b><a class="text-danger" target="_BLANK" href="https://web.dev/bootup-time">'.__("Learn More").'</a></b>';
                                                          }
                                                         ...
                                                         <?php 
                                                          ...
                                                          if(isset($lighthouseresult_audits['offscreen-images']['description'])){
                                                            ...
                                                            $offscreen = explode('[',$lighthouseresult_audits['offscreen-images']['description']);
                                                             echo $offscreen[0] .'<b><a class="text-danger" target="_BLANK" href="https://web.dev/offscreen-images">'.__("Learn More").'</a></b>';
                                                          }
                                                         ...
                                                         <?php 
                                                          ...
                                                          if(isset($lighthouseresult_audits['network-server-latency']['description'])){
                                                            ...
                                                            $network_server_lantency = explode('[',$lighthouseresult_audits['network-server-latency']['description']);
                                                             echo $network_server_lantency[0] .'<b><a class="text-danger" target="_BLANK" href="(https://hpbn.co/primer-on-web-performance/#analyzing-the-resource-waterfall">'.__("Learn More").'</a></b>';
                                                          }
                                                         ...
                                                         <?php 
                                                          ...
                                                          if(isset($lighthouseresult_audits['uses-responsive-images']['description'])){
                                                            ...
                                                            $uses_reponsive_images = explode('[',$lighthouseresult_audits['uses-responsive-images']['description']);
                                                             echo $uses_reponsive_images[0] .'<b><a class="text-danger" target="_BLANK" href="https://hpbn.co/primer-on-web-performance/#analyzing-the-resource-waterfall">'.__("Learn More").'</a></b>';
                                                          }
                                                         ...
                                                         <?php 
                                                          ...
                                                          if(isset($lighthouseresult_audits['unused-css-rules']['description'])){
                                                            ...
                                                            $unused_css_rules = explode('[',$lighthouseresult_audits['unused-css-rules']['description']);
                                                             echo $unused_css_rules[0] .'<b><a class="text-danger" target="_BLANK" href="https://web.dev/unused-css-rules">'.__("Learn More").'</a></b>';
                                                          }
                                                         ...
                                                         <?php 
                                                          ...
                                                          if(isset($lighthouseresult_audits['total-byte-weight']['description'])){
                                                            ...
                                                            $total_byte = explode('[',$lighthouseresult_audits['total-byte-weight']['description']);
                                                             echo $total_byte[0] .'<b><a class="text-danger" target="_BLANK" href="https://web.dev/total-byte-weight">'.__("Learn More").'</a></b>';
                                                          }
                                                         ...
                                                         <?php 
                                                          ...
                                                          if(isset($lighthouseresult_audits['mainthread-work-breakdown']['description'])){
                                                            ...
                                                            $total_byte = explode('[',$lighthouseresult_audits['mainthread-work-breakdown']['description']);
                                                             echo $total_byte[0] .'<b><a class="text-danger" target="_BLANK" href="https://web.dev/mainthread-work-breakdown">'.__("Learn More").'</a></b>';
                                                          }
                                                         ...
                                                         <?php 
                                                          ...
                                                          if(isset($lighthouseresult_audits['uses-webp-images']['description'])){
                                                            ...
                                                            $uses_webp = explode('[',$lighthouseresult_audits['uses-webp-images']['description']);
                                                             echo $uses_webp[0] .'<b><a class="text-danger" target="_BLANK" href="https://web.dev/uses-webp-images">'.__("Learn More").'</a></b>';
                                                          }
                                                         ...
                                                         <?php 
                                                          ...
                                                          if(isset($lighthouseresult_audits['critical-request-chains']['description'])){
                                                            ...
                                                            $critical = explode('[',$lighthouseresult_audits['critical-request-chains']['description']);
                                                             echo $critical[0] .'<b><a class="text-danger" target="_BLANK" href="https://web.dev/critical-request-chains">'.__("Learn More").'</a></b>';
                                                          }
                                                         ...
                                                         <?php 
                                                          ...
                                                          if(isset($lighthouseresult_audits['dom-size']['description'])){
                                                            ...
                                                            $dom_size = explode('[',$lighthouseresult_audits['dom-size']['description']);
                                                             echo $dom_size[0] .'<b><a class="text-danger" target="_BLANK" href="https://developers.google.com/web/fundamentals/performance/rendering/reduce-the-scope-and-complexity-of-style-calculations">'.__("Learn More").'</a></b>';
                                                          }
                                                         ...
                                                         <?php 
                                                          ...
                                                          if(isset($lighthouseresult_audits['redirects']['description'])){
                                                            ...
                                                            $redirects_ss = explode('[',$lighthouseresult_audits['redirects']['description']);
                                                             echo $redirects_ss[0] .'<b><a class="text-danger" target="_BLANK" href="https://web.dev/redirects">'.__("Learn More").'</a></b>';
                                                          }
                                                         ...
                                                         <?php 
                                                          ...
                                                          if(isset($lighthouseresult_audits['unminified-javascript']['description'])){
                                                            ...
                                                            $uniminified_js = explode('[',$lighthouseresult_audits['unminified-javascript']['description']);
                                                             echo $uniminified_js[0] .'<b><a class="text-danger" target="_BLANK" href="https://web.dev/unminified-javascript">'.__("Learn More").'</a></b>';
                                                          }
                                                         ...
                                                         <?php 
                                                          ...
                                                          if(isset($lighthouseresult_audits['user-timings']['description'])){
                                                            ...
                                                            $user_timings = explode('[',$lighthouseresult_audits['user-timings']['description']);
                                                             echo $user_timings[0] .'<b><a class="text-danger" target="_BLANK" href="https://web.dev/user-timings">'.__("Learn More").'</a></b>';
                                                          }
	...
	<div class="row">
		<div class="col-md-6" style="float: left;">
			<ul class="list-group pdf-list-group">
				<li class="list-group-item pdf-list-group-item-active"><?php echo __('IP Information'); ?></li>
				
				<li class="list-group-item"><b><?php echo __('ISP'); ?> : </b>
					<?php echo $domain_info[0]->ipinfo_isp; ?>
				</li>
				
				<li class="list-group-item"><b><?php echo __('IP'); ?> : </b>
					<?php echo $domain_info[0]->ipinfo_ip; ?>
				</li>
				
				<li class="list-group-item"><b><?php echo __('Country'); ?> : </b>
					<?php $x = isset($domain_info[0]->ipinfo_country) ? trim(strtoupper($domain_info[0]->ipinfo_country)) : '';?>
					<img style="height: 15px; width: 20px; margin-top: -3px;" alt=" " src="<?php $s_country = array_search($x, $country_list); echo asset('assets/images/flags/'.$s_country.'.png'); ?>">&nbsp;<?php echo $x; ?>
				</li>
				
				<li class="list-group-item"><b><?php echo __('City'); ?> : </b>
					<?php echo $domain_info[0]->ipinfo_city; ?>
				</li>
				
				<li class="list-group-item"><b><?php echo __('Region'); ?> : </b>
					<?php echo $domain_info[0]->ipinfo_region; ?>
				</li>
				
				<li class="list-group-item"><b><?php echo __('Timezone'); ?> : </b>
					<?php echo $domain_info[0]->ipinfo_time_zone; ?>
				</li>
				
				<li class="list-group-item"><b><?php echo __('Latitude'); ?> : </b>
					<?php echo $domain_info[0]->ipinfo_latitude; ?>
				</li>
				
				<li class="list-group-item"><b><?php echo __('Longitude'); ?> : </b>
		...
		<div class="col-md-6" style="float: right;">
			<ul class="list-group pdf-list-group">
				<li class="list-group-item pdf-list-group-item-active"><?php echo __('Malware Scan Info'); ?></li>

				<li class="list-group-item"><b><?php echo __('Google Safe Browser Norton'); ?> : </b>
					<?php echo $domain_info[0]->google_safety_status; ?>
				</li>

				<li class="list-group-item"><b><?php echo __('Norton'); ?> : </b>
					<?php echo $domain_info[0]->norton_status; ?>
				</li>
			</ul>	
			<br><br><br>
			<ul class="list-group pdf-list-group">
				<li class="list-group-item pdf-list-group-item-active"><?php echo __('Search Engine Index Info'); ?></li>

				<li class="list-group-item"><b><?php echo __('Google Index'); ?> : </b>
					<?php echo $domain_info[0]->google_index_count; ?>
				</li>

				<li class="list-group-item"><b><?php echo __('Bing Index'); ?> : </b>
					<?php echo $domain_info[0]->bing_index_count; ?>
				</li>

				<li class="list-group-item"><b><?php echo __('Yahoo Index'); ?> : </b>
	...
	<div class="row">
		<div class="col-md-6" style="float: left;">
			<ul class="list-group pdf-list-group">
				<li class="list-group-item pdf-list-group-item-active"><?php echo __('Sites in Same IP'); ?></li>
				<?php 
					...
					if(is_array($sites_in_same_ip) && count($sites_in_same_ip)==0) echo '<li class="list-group-item">'.__("No data to show").'</li>';
				?>
		...
		<div class="col-md-6" style="float: right;">
			<ul class="list-group pdf-list-group">
				<li class="list-group-item pdf-list-group-item-active"><?php echo __('Related Websites'); ?></li>
				...
				<?php 
					...
					if(count($similar_sites)==0) echo '<li class="list-group-item">'.__("No data to show").'</li>';
				?>
			</ul>	
		</div>
	</div>
	...
	<div class="row">
		<div class="col-12">
			<ul class="list-group pdf-list-group">
				<li class="list-group-item pdf-list-group-item-active"><?php echo __('Social Network Information'); ?></li>
				
				<li class="list-group-item">
					<div class="col-6" style="float:left;text-align: left;">
						<b style="color:#3578E5 !important;"><?php echo __('Facebook Share'); ?> : </b>
						<?php echo $info['fb_total_share']; ?>
					</div>
					<div class="col-6" style="float:right;text-align: left;">
						<b style="color:#e60023 !important;"><?php echo __('Pinterest Info'); ?> : </b>
						<?php echo $info['pinterest_pin']; ?>
					</div>
				</li>
				<li class="list-group-item">
					<div class="col-6" style="float:left;text-align: left;">
						<b style="color:#3578E5 !important;"><?php echo __('Facebook Comment'); ?> : </b>
						<?php echo $info['fb_total_comment']; ?>
					</div>
					<div class="col-6" style="float:right;text-align: left;">
						<b style="color:#197d2f !important;"><?php echo __('Xing Info'); ?> : </b>
				...
				<li class="list-group-item">
					<div class="col-6" style="float:left;text-align: left;">
						<b style="color:#3578E5 !important;"><?php echo __('Facebook Like'); ?> : </b>
						<?php echo $info['fb_total_like']; ?>
					</div>
					<div class="col-6" style="float:right;text-align: left;">
						<b style="color:#231f20 !important;"><?php echo __('Buffer Info'); ?> : </b>
						<?php echo $info['buffer_share']; ?>
					</div>
				</li>
				<li class="list-group-item">
					<div class="col-6" style="float:left;text-align: left;">
						<b style="color:#ff4500 !important;"><?php echo __('Reddit Score'); ?> : </b>
						<?php echo $info['reddit_score']; ?>
					</div>
					<div class="col-6" style="float:right;text-align: left;">
						<b style="color:#ff4500 !important;"><?php echo __('Reddit Ups'); ?> : </b>
						<?php echo $info['reddit_ups']; ?>
					</div>
				</li>
				<li class="list-group-item">
					<div class="col-6" style="float:left;text-align: left;">
						<b style="color:#ff4500 !important;"><?php echo __('Reddit Downs'); ?> : </b>
...
<div class="row">
	<div class="col-12" >
		<ul class="list-group pdf-list-group">
			<li class="list-group-item pdf-list-group-item-active"><?php echo __('TITLE & METATAGS'); ?></li>
			...
			<?php else : ?>
				<a class="list-group-item list-group-item-action flex-column align-items-start pointer border-right-0 border-left-0">
					<div class="d-block w-100  text-center justify-content-between">
						<h4 class="mb-1 text-danger"><?php echo __('No data Found !'); ?></h4>
					</div>
				</a>
			<?php endif; ?>
		</ul>	
	...
	<ul class="list-group pdf-list-group">
		<div class="col-6" style="float:left; margin-bottom:8px;font-size: 13px;">
			<li class="list-group-item" style="border:none;border-top: 1px solid #6777ef;">
				<strong><?php echo __('BLOCKED BY ROBOTS.TXT'); ?> : </strong> 
		...
		<div class="col-6" style="float:right; margin-bottom:8px;font-size: 13px;">
			<li class="list-group-item" style="border:none;border-top: 1px solid #6777ef;">
				<strong><?php echo __('BLOCKED BY META-ROBOTS'); ?> : </strong> 	
				<span style="color:#4a2fb5">
					<?php 
		...
		<div class="col-6" style="float:left;font-size: 13px;">
			<li class="list-group-item" style="border:none;border-top: 1px solid #6777ef;">
				<strong><?php echo __('LINKS NOFOLLOWED BY META-ROBOTS'); ?> : </strong> 
				<span style="color:#4a2fb5">
					<?php 
		...
		<div class="col-6" style="float:right;font-size: 13px;">
			<li class="list-group-item" style="border:none;border-top: 1px solid #6777ef;">
				<strong><?php echo __('TOTAL KEYWORDS'); ?> : </strong> 
				<span style="color:#4a2fb5">
...
<div class="row">
	<div class="col-12">
		<ul class="list-group pdf-list-group">
			<li class="list-group-item pdf-list-group-item-active"><?php echo __('HTML HEADINGS'); ?></li>
			...
			<li class="list-group-item" style="border:none !important;">
				<ul class="list-group pdf-list-group" style="padding: 0 30px !important">
					...
					<?php if(is_array($h1) && count($h1) > 0) { ?>
						...
						<?php endforeach; ?>
					<?php } else { ?>
						<li class="list-group-item" style="text-align: center;color:#fc544b !important"><?php echo __('No h1 tag found'); ?></li>
					<?php } ?>
				</ul>
			</li>
			...
			<li class="list-group-item" style="border:none !important;">
				<ul class="list-group pdf-list-group" style="padding: 0 30px !important">
					...
					<?php if(is_array($h2) && count($h2) > 0) { ?>
						...
						<?php endforeach; ?>
					<?php } else { ?>
						<li class="list-group-item" style="text-align: center;color:#fc544b !important"><?php echo __('No h2 tag found'); ?></li>
					<?php } ?>
				</ul>
			</li>
			<li class="list-group-item" style="border:none !important;">
				<ul class="list-group pdf-list-group" style="padding: 0 30px !important">
					...
					<?php if(is_array($h3) && count($h3) > 0) { ?>
						...
						<?php endforeach; ?>
					<?php } else { ?>
						<li class="list-group-item" style="text-align: center;color:#fc544b !important"><?php echo __('No h3 tag found'); ?></li>
					<?php } ?>
				</ul>
			</li>
			<li class="list-group-item" style="border:none !important;">
				<ul class="list-group pdf-list-group" style="padding: 0 30px !important">
					...
					<?php if(is_array($h4) && count($h4) > 0) { ?>
						...
						<?php endforeach; ?>
					<?php } else { ?>
						<li class="list-group-item" style="text-align: center;color:#fc544b !important"><?php echo __('No h4 tag found'); ?></li>
					<?php } ?>
				</ul>
			</li>
			<li class="list-group-item" style="border:none !important;">
				<ul class="list-group pdf-list-group" style="padding: 0 30px !important">
					...
					<?php if(is_array($h5) && count($h5) > 0) { ?>
						...
						<?php endforeach; ?>
					<?php } else { ?>
						<li class="list-group-item" style="text-align: center;color:#fc544b !important"><?php echo __('No h5 tag found'); ?></li>
					<?php } ?>
				</ul>
			</li>
			<li class="list-group-item" style="border:none !important;">
				<ul class="list-group pdf-list-group" style="padding: 0 30px !important">
					...
					<?php if(is_array($h6) && count($h6) > 0) { ?>
						...
						<?php endforeach; ?>
					<?php } else { ?>
						<li class="list-group-item" style="text-align: center;color:#fc544b !important"><?php echo __('No h6 tag found'); ?></li>
					<?php } ?>
				</ul>
			</li>
		</ul>
...
<div class="row">
	<div class="col-12">
		<ul class="list-group pdf-list-group">
			<li class="list-group-item pdf-list-group-item-active"><?php echo __('KEYWORD ANALYSIS'); ?></li>
			
			<li class="list-group-item" style="border:none !important;">
				<ul class="list-group pdf-list-group" style="padding: 0 30px !important;">
					<li class="table-styles">== <?php echo __('Single Word Keywords'); ?> ==</li>
						...
						<div class="table-responsive">
							<table class="table table-bordered">
								...
								<tbody>
									...
									<?php endforeach; ?>
									<?php else : ?>
										<tr><td colspan="4" style="text-align: center;color:#fc544b !important"><?php echo __("No data found"); ?></td></tr>
									<?php endif; ?>
								</tbody>
							</table>
						</div>
			...
			<li class="list-group-item" style="border:none !important;">
				<ul class="list-group pdf-list-group" style="padding: 0 30px !important;">
					<li class="table-styles">== <?php echo __('Two Words Keywords'); ?> ==</li>
					<li class="list-group-item" style="padding:0 !important;border:none !important;">
						<div class="table-responsive">
							<table class="table table-bordered">
								<thead>
			...
			<li class="list-group-item" style="border:none !important;">
				<ul class="list-group pdf-list-group" style="padding: 0 30px !important;">
					<li class="table-styles">== <?php echo __('Three Words Keywords'); ?> ==</li>
					<li class="list-group-item" style="padding:0 !important;border:none !important;">
						<div class="table-responsive">
							<table class="table table-bordered">
								<thead>
			...
			<li class="list-group-item" style="border:none !important;">
				<ul class="list-group pdf-list-group" style="padding: 0 30px !important;">
					<li class="table-styles">== <?php echo __('Four Words Keywords'); ?> ==</li>
					<li class="list-group-item" style="padding:0 !important;border:none !important;">
						<div class="table-responsive">
							<table class="table table-bordered">
								<thead>
...
{{-- <div class="row">
	<div class="col-12">
		<h3><div class="well text-center"><?php echo __('Alexa Information').' - '.$domain_info[0]->domain_name; ?></div></h3>
	</div>
</div>
...
<div class="row">
	<div class="col-12">
		<ul class="list-group pdf-list-group">
			<li class="list-group-item pdf-list-group-item-active"><?php echo __('General Information'); ?></li>
			
			<li class="list-group-item">
				<div class="col-6" style="float:left;text-align: left;">
					<b style="color:#6777ef !important;"><?php echo __('Domain Name'); ?> : </b>
					<?php echo $domain; ?>
				</div>
				<div class="col-6" style="float:right;text-align: left;">
					<b style="color:#63ed7a !important;"><?php echo __('Global Rank'); ?> : </b>
					<?php echo $alexa_rank; ?>
				</div>
			</li>
			<li class="list-group-item">
				<div class="col-6" style="float:left;text-align: left;">
					<b style="color:#ffa426 !important;"><?php echo __('Daily Time on Site'); ?> : </b>
					<?php echo $alexa_rank_spend_time; ?>
				</div>
				<div class="col-6" style="float:right;text-align: left;">
					<b style="color:#3abaf4 !important;"><?php echo __('Search Traffic'); ?> : </b>
			...
			<li class="list-group-item">
				<div class="col-6" style="float:left;text-align: left;">
					<b style="color:#fc544b !important;"><?php echo __('Bounce Rate'); ?> : </b>
					<?php echo $bounce_rate; ?>
				</div>
				<div class="col-6" style="float:right;text-align: left;">
					<b style="color:#a45fff !important;"><?php echo __('Total Sites Link In'); ?> : </b>
...
<div class="row">
	<div class="col-12">
		<ul class="list-group pdf-list-group">
			<li class="list-group-item pdf-list-group-item-active"><?php echo __('Top 5 Similar Sites by Audience Overlap'); ?></li>
					...
					<table class="table table-bordered">
						<thead>
							<tr>
								...
								<th><?php echo __('Similar sites'); ?></th>
								<th><?php echo __('Overlap score'); ?></th>
							</tr>
						</thead>
...
<div class="row">
	<div class="col-12">
		<ul class="list-group pdf-list-group">
			<li class="list-group-item pdf-list-group-item-active"><?php echo __('Top 5 Keywords By Traffic'); ?></li>
			<li class="list-group-item" style="padding:0 !important;text-align:center;border:none !important;">
				<div class="table-responsive">
					<table class="table table-bordered">
						<thead>
							<tr>
								<th scope="col"><?php echo __('Keywords'); ?></th>
								<th scope="col"><?php echo __('Search Traffic'); ?></th>
								<th scope="col"><?php echo __('Share of Voice'); ?></th>
							</tr>
						</thead>
...
<div class="row">
	<div class="col-12">
		<ul class="list-group pdf-list-group">
			<li class="list-group-item pdf-list-group-item-active"><?php echo __('Top 4 Keyword Gaps'); ?></li>
			<li class="list-group-item" style="padding:0 !important;text-align:center;border:none !important;">
				<div class="table-responsive">
					<table class="table table-bordered">
						<thead>
							<tr>
								<th><?php echo __('Keywords driving traffic to competitors, but not to this site'); ?></th>
								<th><?php echo __('Avg. Traffic to Competitors'); ?></th>
								<th><?php echo __('Search Popularity'); ?></th>
							</tr>
						</thead>
...
<div class="row">
	<div class="col-12">
		<ul class="list-group pdf-list-group">
			<li class="list-group-item pdf-list-group-item-active"><?php echo __('Top 4 Easy-to-Rank Keywords'); ?></li>
			<li class="list-group-item" style="padding:0 !important;text-align:center;border:none !important;">
				<div class="table-responsive">
					<table class="table table-bordered">
						<thead>
							<tr>
								<th><?php echo __('Popular keywords within this site`s competitive power'); ?></th>
								<th><?php echo __('Relevance to this site'); ?></th>
								<th><?php echo __('Search Popularity'); ?></th>
							</tr>
						</thead>
...
<div class="row">
	<div class="col-12">
		<ul class="list-group pdf-list-group">
			<li class="list-group-item pdf-list-group-item-active"><?php echo __('Top 4 Buyer Keywords'); ?></li>
			<li class="list-group-item" style="padding:0 !important;text-align:center;border:none !important;">
				<div class="table-responsive">
					<table class="table table-bordered">
						<thead>
							<tr>
								<th><?php echo __('Keywords that show a high purchase intent'); ?></th>
								<th><?php echo __('Avg. Traffic to Competitors'); ?></th>
								<th><?php echo __('Organic Competition'); ?></th>
							</tr>
						</thead>
...
<div class="row">
	<div class="col-12">
		<ul class="list-group pdf-list-group">
			<li class="list-group-item pdf-list-group-item-active"><?php echo __('Top 4 Optimization Opportunities'); ?></li>
			<li class="list-group-item" style="padding:0 !important;text-align:center;border:none !important;">
				<div class="table-responsive">
					<table class="table table-bordered">
						<thead>
							<tr>
								<th><?php echo __('Very popular keywords already driving some traffic to this site'); ?></th>
								<th><?php echo __('Search Popularity'); ?></th>
								<th><?php echo __('Organic Share of Voice'); ?></th>
							</tr>
						</thead>
...
<div class="row">
	<div class="col-12">
		<ul class="list-group pdf-list-group">
			<li class="list-group-item pdf-list-group-item-active"><?php echo __('Top 5 Referral Sites'); ?></li>
			<li class="list-group-item" style="padding:0 !important;text-align:center;border:none !important;">
				<div class="table-responsive">
					<table class="table table-bordered">
						<thead>
							<tr>
								<th scope="col"><?php echo __('Sites by how many other sites drive traffic to them'); ?></th>
								<th scope="col"><?php echo __('Referral Sites'); ?></th>
							</tr>
						</thead>
...
<div class="row">
	<div class="col-12">
		<ul class="list-group pdf-list-group">
			<li class="list-group-item pdf-list-group-item-active"><?php echo __('Site Flow'); ?></li>
			<li class="list-group-item" style="padding:0 !important;text-align:center;border:none !important;">
				<div class="table-responsive">
					<table class="table table-bordered" style="text-align:left;">
						<thead>
							<tr>
								<th><?php echo __('Visited just before & right after domain'); ?></th>
								<th><?php echo __('Visited just before & right after domain Percentage'); ?></th>
							</tr>
						</thead>
...
<div class="row">
	<div class="col-12">
		<ul class="list-group pdf-list-group">
			<li class="list-group-item pdf-list-group-item-active"><?php echo __('Top 5 Audience Overlap'); ?></li>
			<li class="list-group-item" style="padding:0 !important;text-align:center;border:none !important;">
				<div class="table-responsive">
					<table class="table table-bordered" style="text-align:left;">
						<thead>
							<tr>
								<th><?php echo __('Similar Sites to This Site'); ?></th>
								<th><?php echo __('Site’s Overlap Score'); ?></th>
								<th><?php echo __('Alexa Rank'); ?></th>
							</tr>
						</thead>
...
<div class="row">
	<div class="col-12">
		<ul class="list-group pdf-list-group">
			<li class="list-group-item pdf-list-group-item-active"><?php echo __('Top 3 Audience Geography'); ?></li>
			<li class="list-group-item" style="padding:0 !important;text-align:center;border:none !important;">
				<div class="table-responsive">
					<table class="table table-bordered" style="text-align:left;">
						<thead>
							<tr>
								<th><?php echo __('Visitors by Country'); ?></th>
								<th><?php echo __('Visitors by Country Percentage'); ?></th>
							</tr>
						</thead>
