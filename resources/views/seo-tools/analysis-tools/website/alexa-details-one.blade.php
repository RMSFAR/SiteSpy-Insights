...
<div class="row">
	<div class="col-12 col-md-8">
		<div class="card">
			<div class="card-header">
				<h4><i class="fas fa-bars"></i> {{ __('Alexa Data')}}</h4>
			</div>
				...
				<div class="row">
					...
					<div class="col-12 col-md-6">
						<div class="card card-statistic-1">
							...
							<div class="card-wrap">
								<div class="card-header">
									<h4>{{ __('Domain Name')}}</h4>
								</div>
								<div class="card-body"><h6 class="mt-2">{{ $domain}}</h6></div>
							</div>
						</div>
					</div>
					...
					<div class="col-12 col-md-6">
						<div class="card card-statistic-1">
							...
							<div class="card-wrap">
								<div class="card-header">
									<h4>{{ __('Global Rank')}}
										<a href="#" data-placement="top" data-trigger="focus" data-toggle="popover" title="{{ __("Global Rank")}}" data-content="{{ __("This site ranks in global internet engagement.")}}"><i class='fa fa-info-circle'></i> </a>
									</h4>
								</div>
								<div class="card-body"><h6 class="mt-2">{{ $alexa_rank}}</h6></div>
							</div>
						</div>
					</div>
					...
					<div class="col-12 col-md-6">
						<div class="card card-statistic-1">
							...
							<div class="card-wrap">
								<div class="card-header">
									<h4>{{ __('Daily Time on Site')}}
										<a href="#" data-placement="top" data-trigger="focus" data-toggle="popover" title="{{ __("Daily Time on Site")}}" data-content="{{ __("Average time in minutes and seconds that a visitor spends on this site each day.")}}"><i class='fa fa-info-circle'></i> </a>
									</h4>
								</div>
								<div class="card-body"><h6 class="mt-2">{{ $alexa_rank_spend_time}}</h6></div>
							</div>
						</div>
					</div>
					...
					<div class="col-12 col-md-6">
						<div class="card card-statistic-1">
							...
							<div class="card-wrap">
								<div class="card-header">
									<h4>{{ __('Search Traffic')}}
										<a href="#" data-placement="top" data-trigger="focus" data-toggle="popover" title="{{ __("Search Traffic")}}" data-content="{{ __("The percentage of organic search referrals to this site.")}}"><i class='fa fa-info-circle'></i> </a>
									</h4>
								</div>
								<div class="card-body"><h6 class="mt-2">{{ $site_search_traffic}}</h6></div>
							</div>
						</div>
					</div>
					...
					<div class="col-12 col-md-6">
						<div class="card card-statistic-1">
							...
							<div class="card-wrap">
								<div class="card-header">
									<h4>{{ __('Bounce Rate')}}
										<a href="#" data-placement="top" data-trigger="focus" data-toggle="popover" title="{{ __("Bounce Rate")}}" data-content="{{ __("Percentage of visits to the site that consist of a single pageview.")}}"><i class='fa fa-info-circle'></i> </a>
									</h4>
								</div>
								<div class="card-body">{{ $bounce_rate}}</div>
							</div>
						</div>
					</div>
					...
					<div class="col-12 col-md-6">
						<div class="card card-statistic-1">
							...
							<div class="card-wrap">
								<div class="card-header">
									<h4>{{ __('Total Sites Link In')}}
										<a href="#" data-placement="top" data-trigger="focus" data-toggle="popover" title="{{ __("Total Sites Link In")}}" data-content="{{ __("Sites that link to this site, recalculated weekly.")}}"><i class='fa fa-info-circle'></i> </a>
									</h4>
								</div>
								<div class="card-body">{{ $total_sites_linking_in}}</div>
							</div>
						</div>
					</div>
				</div>
	...
	<div class="col-12 col-md-4">
		<div class="card">
			<div class="card-header">
				<h4><i class="fas fa-bug"></i> {{ __('Keyword Opportunities Breakdown')}}
					<a href="#" data-placement="top" data-trigger="focus" data-toggle="popover" title="{{ __("Keyword Opportunities Breakdown")}}" data-content="{{ __("These are customized keyword recommendations this site could target to drive more traffic.")}}"><i class='fa fa-info-circle'></i> </a>
				</h4>
			</div>
				...
				<ul class="list-unstyled list-unstyled-border list-unstyled-noborder mb-0 mt-4">
					<li class="media mb-0 pb-0 border-bottom-0">
						...
						<div class="media-body ml-2">
							<div class="media-title font-12">{{ __('Keyword Gaps')}} <span class="red">({{ $keyword_opportunitites_values_pie_chart['Keyword Gaps']}})</span></div>
						</div>
					</li>
					<li class="media mb-0 pb-0 border-bottom-0">
						<div class='social_shared_icon' style='margin-top:10px !important;background-color: #f45c44 !important;'></div>
						<div class="media-body ml-2">
							<div class="media-title font-12">{{ __('Easy-to-Rank Keywords')}} <span class="red">({{ $keyword_opportunitites_values_pie_chart['Easy-to-Rank Keywords']}})</span></div>
						</div>
					</li>
					<li class="media mb-0 pb-0 border-bottom-0">
						<div class='social_shared_icon' style='margin-top:10px !important;background-color: #f8b646 !important;'></div>
						<div class="media-body ml-2">
							<div class="media-title font-12">{{ __('Optimization Opportunities')}} <span class="red">({{ $keyword_opportunitites_values_pie_chart['Optimization Opportunities']}})</span></div>
						</div>
					</li>
					<li class="media mb-0 pb-0 border-bottom-0">
						<div class='social_shared_icon' style='margin-top:10px !important;background-color: #55476a !important;'></div>
						<div class="media-body ml-2">
							<div class="media-title font-12">{{ __('Buyer Keywords')}} <span class="red">({{ $keyword_opportunitites_values_pie_chart['Buyer Keywords']}})</span></div>
						</div>
					</li>
				</ul>
			...
			<div class="card-footer pt-0">
				<div class="buttons text-center">
					<button type="button" class="btn btn-primary">
						<i class="fas fa-plane"></i> {{ __('Total')}} <span class="badge badge-transparent">{{ $total_keyword_opportunities_breakdown}}</span>
					</button>
				</div>
			</div>
		</div>
...
<div class="row">
	...
	<div class="col-12 col-md-6">
		<div class="card data-card card-primary">
			<div class="card-header">
				<h4><i class="fas fa-globe"></i> {{ __('Top 5 Similar Sites by Audience Overlap')}}
					<a href="#" data-placement="top" data-trigger="focus" data-toggle="popover" title="{{ __("Similar Sites by Audience Overlap")}}" data-content="{{ __("Sites that share the same visitors and search keywords with this site, sorted by most overlap to least overlap.")}}"><i class='fa fa-info-circle'></i> </a>
				</h4>
			</div>
	...
	<div class="col-12 col-md-6">
		<div class="card data-card card-primary">
			<div class="card-header">
				<h4><i class="fas fa-globe"></i> {{ __('Top 5 Keywords By Traffic')}}
					<a href="#" data-placement="top" data-trigger="focus" data-toggle="popover" title="{{ __("Top 5 Keywords By Traffic")}}" data-content="{{ __("Top organic keywords that are driving traffic to this site.")}}"><i class='fa fa-info-circle'></i> </a>
				</h4>
			</div>
			...
			<div class="card-body">
				<div class="table-responsive" style="height:400px;">
					<table class="table table-hover table-bordered">
						<thead class="thead-light thead-primary">
							<tr>
								<th scope="col">{{ __('Keywords')}}
									<a href="#" data-placement="top" data-trigger="focus" data-toggle="popover" title="{{ __("Keywords")}}" data-content="{{ __("Top organic keywords that are driving traffic to this site.")}}"><i class='fa fa-info-circle'></i> </a>
								</th>
								<th scope="col">{{ __('Search Traffic')}}
									<a href="#" data-placement="top" data-trigger="focus" data-toggle="popover" title="{{ __("Search Traffic")}}" data-content="{{ __("The percentage of organic search referrals to this site that come from this keyword.")}}"><i class='fa fa-info-circle'></i> </a>
								</th>
								<th scope="col">{{ __('Share of Voice')}}
									<a href="#" data-placement="top" data-trigger="focus" data-toggle="popover" title="{{ __("Organic Share of Voice")}}" data-content="{{ __("The percentage of all searches for this keyword that sent traffic to this website.")}}"><i class='fa fa-info-circle'></i> </a>
								</th>
							</tr>
						</thead>
						<tbody>
	...
	<div class="col-12 col-md-6">
		<div class="card data-card card-primary">
			<div class="card-header">
				<h4><i class="fas fa-globe"></i> {{ __('Top 4 Keyword Gaps')}}</h4>
			</div>
			...
			<div class="card-body">
				<div class="table-responsive" style="height:400px;">
					<table class="table table-hover table-bordered">
						<thead class="thead-light thead-primary">
							<tr>
								<th scope="col">{{ __('Keywords driving traffic to competitors, but not to this site')}}
									<a href="#" data-placement="top" data-trigger="focus" data-toggle="popover" title="{{ __("Keywords driving traffic to competitors, but not to this site")}}" data-content="{{ __("This site is not gaining any traffic from these keywords.If competitors are gaining traffic from the keyword, this may be a good investment opportunity.")}}"><i class='fa fa-info-circle'></i> </a>
								</th>
								<th scope="col">{{ __('Avg. Traffic to Competitors')}}
									<a href="#" data-placement="top" data-trigger="focus" data-toggle="popover" title="{{ __("Avg. Traffic to Competitors")}}" data-content="{{ __("An estimate of the traffic that competitors are getting for this keyword.The score is based on the popularity of the keyword, and how well competitors rank for it.The score ranges from 1 (least traffic) to 100 (most traffic).")}}"><i class='fa fa-info-circle'></i> </a>
								</th>
								<th scope="col">{{ __('Search Popularity')}}
									<a href="#" data-placement="top" data-trigger="focus" data-toggle="popover" title="{{ __("Organic Share of Voice")}}" data-content="{{ __("An estimate of how frequently this keyword is searched across all search engines.The score ranges from 1 (least popular) to 100 (most popular).")}}"><i class='fa fa-info-circle'></i> </a>
								</th>
							</tr>
						</thead>
						<tbody>
	...
	<div class="col-12 col-md-6">
		<div class="card data-card card-primary">
			<div class="card-header">
				<h4><i class="fas fa-globe"></i> {{ __('Top 4 Easy-to-Rank Keywords')}}</h4>
			</div>
			...
			<div class="card-body">
				<div class="table-responsive" style="height:400px;">
					<table class="table table-hover table-bordered">
						<thead class="thead-light thead-primary">
							<tr>
								<th scope="col">{{ __('Popular keywords within this site`s competitive power')}}
									<a href="#" data-placement="top" data-trigger="focus" data-toggle="popover" title="{{ __("Easy-to-Rank Keywords")}}" data-content="{{ __("Popular keywords within this site's competitive power.")}}"><i class='fa fa-info-circle'></i> </a>
								</th>
								<th scope="col">{{ __('Relevance to this site')}}
									<a href="#" data-placement="top" data-trigger="focus" data-toggle="popover" title="{{ __("Relevance to this site")}}" data-content="{{ __("An estimate of how relevant a keyword is to this site.The score is based on the keyword's relevance to other keywords that currently drive traffic to this site.The score ranges from 1 (least relevant) to 100 (most relevant).")}}"><i class='fa fa-info-circle'></i> </a>
								</th>
								<th scope="col">{{ __('Search Popularity')}}
									<a href="#" data-placement="top" data-trigger="focus" data-toggle="popover" title="{{ __("Search Popularity")}}" data-content="{{ __("An estimate of how frequently this keyword is searched across all search engines.The score ranges from 1 (least popular) to 100 (most popular).")}}"><i class='fa fa-info-circle'></i> </a>
								</th>
							</tr>
						</thead>
						<tbody>
	...
	<div class="col-12 col-md-6">
		<div class="card data-card card-primary">
			<div class="card-header">
				<h4><i class="fas fa-globe"></i> {{ __('Top 4 Buyer Keywords')}}</h4>
			</div>
			...
			<div class="card-body">
				<div class="table-responsive" style="height:400px;">
					<table class="table table-hover table-bordered">
						<thead class="thead-light thead-primary">
							<tr>
								<th scope="col">{{ __('Keywords that show a high purchase intent')}}
									<a href="#" data-placement="top" data-trigger="focus" data-toggle="popover" title="{{ __("Buyer Keyword")}}" data-content="{{ __("These keywords include certain phrases commonly associated with purchases.")}}"><i class='fa fa-info-circle'></i> </a>
								</th>
								<th scope="col">{{ __('Avg. Traffic to Competitors')}}
									<a href="#" data-placement="top" data-trigger="focus" data-toggle="popover" title="{{ __("Avg. Traffic to Competitors")}}" data-content="{{ __("An estimate of the traffic that competitors are getting for this keyword.The score is based on the popularity of the keyword, and how well competitors rank for it.The score ranges from 1 (least traffic) to 100 (most traffic).")}}"><i class='fa fa-info-circle'></i> </a>
								</th>
								<th scope="col">{{ __('Organic Competition')}}
									<a href="#" data-placement="top" data-trigger="focus" data-toggle="popover" title="{{ __("Organic Competition")}}" data-content="{{ __("An estimate of how difficult it is to rank highly for this keyword in organic search.The score ranges from 1 (least competition) to 100 (most competition).")}}"><i class='fa fa-info-circle'></i> </a>
								</th>
							</tr>
						</thead>
						<tbody>
	...
	<div class="col-12 col-md-6">
		<div class="card data-card card-primary">
			<div class="card-header">
				<h4><i class="fas fa-globe"></i> {{ __('Top 4 Optimization Opportunities')}}</h4>
			</div>
			...
			<div class="card-body">
				<div class="table-responsive" style="height:400px;">
					<table class="table table-hover table-bordered">
						<thead class="thead-light thead-primary">
							<tr>
								<th scope="col">{{ __('Very popular keywords already driving some traffic to this site')}}
									<a href="#" data-placement="top" data-trigger="focus" data-toggle="popover" title="{{ __("Optimization Opportunities")}}" data-content="{{ __("Growing traffic for these popular keywords may be easier than trying to rank for brand new keywords.")}}"><i class='fa fa-info-circle'></i> </a>
								</th>
								<th scope="col">{{ __('Search Popularity')}}
									<a href="#" data-placement="top" data-trigger="focus" data-toggle="popover" title="{{ __("Search Popularity")}}" data-content="{{ __("An estimate of how frequently this keyword is searched across all search engines.The score ranges from 1 (least popular) to 100 (most popular).")}}"><i class='fa fa-info-circle'></i> </a>
								</th>
								<th scope="col">{{ __('Organic Share of Voice')}}
									<a href="#" data-placement="top" data-trigger="focus" data-toggle="popover" title="{{ __("Organic Share of Voice")}}" data-content="{{ __("The percentage of all searches for this keyword that sent traffic to this website.")}}"><i class='fa fa-info-circle'></i> </a>
								</th>
							</tr>
						</thead>
	...
	<div class="col-12 col-md-6">
		<div class="card data-card card-primary">
			<div class="card-header">
				<h4><i class="fas fa-globe"></i> {{ __('Top 5 Referral Sites')}}</h4>
			</div>
			...
			<div class="card-body">
				<div class="table-responsive" style="height:400px;">
					<table class="table table-hover table-bordered">
						<thead class="thead-light thead-primary">
							<tr>
								<th scope="col">{{ __('Sites by how many other sites drive traffic to them')}}
									<a href="#" data-placement="top" data-trigger="focus" data-toggle="popover" title="{{ __("Optimization Opportunities")}}" data-content="{{ __("Ordered by how many other websites link to them, which can be used to evaluate a site's reputation on the internet.")}}"><i class='fa fa-info-circle'></i> </a>
								</th>
								<th scope="col">{{ __('Referral Sites')}}
									<a href="#" data-placement="top" data-trigger="focus" data-toggle="popover" title="{{ __("Referral Sites")}}" data-content="{{ __("Also referred to as 'Sites Linking In', this is the number of sites linking to facebook.com that Alexa's web crawl has found.")}}"><i class='fa fa-info-circle'></i> </a>
								</th>
							</tr>
						</thead>
						<tbody>
	...
	<div class="col-12 col-md-6">
		<div class="card data-card card-primary">
			<div class="card-header">
				<h4><i class="fas fa-globe"></i> {{ __('Site Flow')}}</h4>
			</div>
			...
			<div class="card-body">
				<div class="table-responsive" style="height:400px;">
					<table class="table table-hover table-bordered">
						<thead class="thead-light thead-primary">
							<tr>
								<th scope="col">{{ __('Visited just before & right after domain')}}
									<a href="#" data-placement="top" data-trigger="focus" data-toggle="popover" title="{{ __("Visited just before domain")}}" data-content="{{ __("Sites that people visited immediately before this one.")}}"><i class='fa fa-info-circle'></i> </a>
								</th>
								<th scope="col">{{ __('Visited just before & right after domain Percentage')}}</th>
							</tr>
						</thead>
						<tbody>
							<?php 
	...
	<div class="col-12 col-md-6">
		<div class="card data-card card-primary">
			<div class="card-header">
				<h4><i class="fas fa-globe"></i> {{ __('Top 5 Audience Overlap')}}</h4>
			</div>
			...
			<div class="card-body">
				<div class="table-responsive" style="height:400px;">
					<table class="table table-hover table-bordered">
						<thead class="thead-light thead-primary">
							<tr>
								<th scope="col">{{ __('Similar Sites to This Site')}}</th>
								<th scope="col">{{ __('Site’s Overlap Score')}}
									<a href="#" data-placement="top" data-trigger="focus" data-toggle="popover" title="{{ __("Site’s Overlap Score")}}" data-content="{{ __("A relative level of audience overlap between this site and similar sites. Audience overlap score is calculated from an analysis of common visitors and/or search keywords.A site with a higher score shows higher audience overlap than a site with lower score.")}}"><i class='fa fa-info-circle'></i> </a>
								</th>
								<th scope="col">{{ __('Alexa Rank')}}
									<a href="#" data-placement="top" data-trigger="focus" data-toggle="popover" title="{{ __("Alexa Rank")}}" data-content="{{ __("An estimate of this site's popularity.The rank is calculated using a combination of average daily visitors to this site and pageviews on this site over the past 3 months. The site with the highest combination of visitors and pageviews is ranked #1.Updated Daily.")}}"><i class='fa fa-info-circle'></i> </a>
								</th>
							</tr>
						</thead>
						<tbody>
	...
	<div class="col-12 col-md-6">
		<div class="card data-card card-primary">
			<div class="card-header">
				<h4><i class="fas fa-globe"></i> {{ __('Top 3 Audience Geography')}}</h4>
			</div>
			...
			<div class="card-body">
				<div class="table-responsive" style="height:400px;">
					<table class="table table-hover table-bordered">
						<thead class="thead-light thead-primary">
							<tr>
								<th scope="col">{{ __('Visitors by Country')}}</th>
								<th scope="col">{{ __('Visitors by Country Percentage')}}</th>
							</tr>
						</thead>
						<tbody>
							<?php 
...
<script>
    var only_keys ={!! json_encode(array_keys($keyword_opportunitites_values_pie_chart)) !!}
    var only_values ={!! json_encode(array_values($keyword_opportunitites_values_pie_chart)) !!}
</script>
