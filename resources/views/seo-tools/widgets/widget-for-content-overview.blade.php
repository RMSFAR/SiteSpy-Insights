...
<div class="card border">
	<div class="card-header">
		<h4><i class="fa fa-star"></i> <?php echo __('Top Web Pages From'); ?> &nbsp;&nbsp;<span class="bg-danger badge-pill float-right text-white small"><?php echo $from_date." to ".$to_date; ?></span></h4>
	</div>
			...
			<div class="col-12">
				<?php  
					if(empty($content_overview_data)) {
						echo "<div class='text-center font-weight-bold h5'>".__('No data to show')."</div>";
					} else {
						$i = 0;
