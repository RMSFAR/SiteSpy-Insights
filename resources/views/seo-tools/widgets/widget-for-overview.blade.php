...
<div class="card border">
	<div class="card-header">
		<h4><?php echo __('Report For Last 30 Days'); ?></h4>
	</div>
	...
	<div class="card-body">
		<div class="row">
			<div class="col-12 col-md-6">
				<div class="card card-statistic-1">
					...
					<div class="card-wrap">
						<div class="card-header">
							<h4><?php echo __('Total Unique Visitor'); ?></h4>
						</div>
			...
			<div class="col-12 col-md-6">
				<div class="card card-statistic-1">
					...
					<div class="card-wrap">
						<div class="card-header">
							<h4><?php echo __('Total Page View'); ?></h4>
						</div>
		...
		<div class="row mb-4">
			<div class="col-12 col-md-4">
				<div>
					<label class="text-primary"><?php echo __('Average Visit'); ?></label>
			...
			<div class="col-12 col-md-4">
				<div>
					<label class="text-warning"><?php echo __('Average Stay Time'); ?></label>
			...
			<div class="col-12 col-md-4">
				<div>
					<label class="text-danger"><?php echo __('Bounce Rate'); ?></label>
	...
	<div class="card-body text-center">
		<img class="img-fluid" src="<?php echo asset("assets/img/drawkit/drawkit-nature-man-colour.svg"); ?>" style="height: 200px" alt="image">
