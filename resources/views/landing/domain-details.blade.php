		...
		<div class="card">
			...
			<div class="card-header">
				...
				<div class="card-header-action">
					<a href="{{ url('home/download_analysis_report/'.$id)}}" class="btn btn-lg btn-primary" title="{{ __('Download Report as Pdf')}}"><i class="fas fa-cloud-download-alt"></i> {{ __('Download Report')}}</a>
				</div>
			</div>
