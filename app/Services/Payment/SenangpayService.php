...
class SenangpayService implements SenangpayServiceInterface
{
    ...
    function set_button(){
        $button_lang = !empty($this->button_lang)?$this->button_lang:__("Pay With Senangpay");
        ...
        if($this->secondary_button)
            $button .= "
				...
				<small class='text-muted'><img class='rounded' width='60' height='60' src='".asset('assets/img/payment/senangPay.png')."'></small>
